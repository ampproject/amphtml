...
def GenerateValidatorGeneratedPHP(specfile, validator_pb2, text_format,
  ...
  out.append('<?php')
  out.append('//')
  out.append('// Generated by validator_gen_php.py - do not edit.')
  out.append('//   validator_gen_php.py is available in a Lullabot forked repo https://github.com/Lullabot/amphtml')
  out.append('//   Be sure to look in the `php-validator-generated` branch of the repo in the `validator` folder')
  out.append('')
