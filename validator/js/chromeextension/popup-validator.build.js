...
i(o, function (e) {
if (e.attributes && (!e.attributeFilter || !e.attributeFilter.length || e.attributeFilter.indexOf(t) !== -1 || e.attributeFilter.indexOf(n) !== -1))
...
i(o, function (e) {
if (e.characterData)
return e.characterDataOldValue ? c(a) : r;
});
break;
case 'DOMNodeRemoved':
...
var p = f.previousSibling, w = f.nextSibling, r = u('childList', e.target.parentNode);
...
function i() {
y = !1;
for (var e, t = N, n = 0, o = t.length; n < o && (e = t[n]); n++)
e();
N = [];
}
function a(e) {
...
var g = e.flags, b = e.forSubtree, E = e.forDocumentTree, _ = window.MutationObserver._isPolyfilled && g['throttle-attached'];
e.hasPolyfillMutations = _, e.hasThrottledAttached = _;
var y = !1, N = [], M = Array.prototype.forEach.call.bind(Array.prototype.forEach), O = Element.prototype.createShadowRoot;
...
var m, v = (e.isIE, e.upgradeDocumentTree), h = e.upgradeAll, g = e.upgradeWithDefinition, b = e.implementPrototype, E = e.useNative, _ = [
'annotation-xml',
'color-profile',
'font-face',
'font-face-src',
...
'font-face-name',
'missing-glyph'
], y = {}, N = 'http://www.w3.org/1999/xhtml', M = document.createElement.bind(document), O = document.createElementNS.bind(document);
...
this.$.errorsTab.textContent = chrome.i18n.getMessage('errorsTabText', [errors.length]);
},
setWarnings: function (warnings) {
var warningsPage = this.$.warningsPage;
warningsPage.results = warnings;
this.$.warningsTab.textContent = chrome.i18n.getMessage('warningsTabText', [warnings.length]);
}
});
Polymer({
is: 'popup-validator',
...
processTab(tabs, toolbar, content);
});
}
});
...
validationResult = JSON.parse(backgroundPage.sessionStorage.getItem(url));
if (validationResult) {
...
if (xhr.readyState === 4) {
amp.validator.init().then(function () {
validationResult = amp.validator.validateString(xhr.responseText);
processResult(validationResult, toolbar, content, url);
});
}
};
