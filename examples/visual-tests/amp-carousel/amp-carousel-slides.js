...
module.exports = {
  ...
  'advance to second slide - snapshot freezes animation on first': async (
    page,
    name
  ) => {
    ...
    await verifySelectorsVisible(page, name, [
      ...
      '.amp-carousel-button-next[aria-disabled="false"]',
      '.amp-carousel-button-prev[aria-disabled="false"]',
    ]);
    await page.evaluate(() => {
  ...
  // it should have, because of the aria-hidden and aria-disabled states on the
  // active slides and prev/next arrows.
  'advance to last slide - snapshot freezes animation on second': async (
    page,
    name
  ) => {
    await page.evaluate(calcCLS);
    ...
    await verifySelectorsVisible(page, name, [
      ...
      '.amp-carousel-button-next[aria-disabled="true"]',
      '.amp-carousel-button-prev[aria-disabled="false"]',
    ]);
    await page.evaluate(() => {
      document.body.appendChild(
