...
describe.configure().run('install-error-reporting', function() {
  ...
  describe('getErrorReportData', () => {
    ...
    it('reportError mark asserts without error object', () => {
      ...
      const data = getErrorReportData(e.message, undefined, undefined,
          undefined);
      expect(data.m).to.equal('XYZ');
      expect(data.a).to.equal('1');
      expect(data.v).to.equal(
    ...
    it('reportError marks binary type', () => {
      ...
      const data1 = getErrorReportData(undefined, undefined, undefined,
          undefined, e1);
      ...
      const data2 = getErrorReportData(undefined, undefined, undefined,
          undefined, e2);
    ...
    it('reportError without error object', () => {
      const data = getErrorReportData('foo bar', 'foo.js', '11', '22',
          undefined);
