...
describe('Rendering of amp-img', () => {
  ...
  it('should be present', () => {
    ...
    return fixture.awaitEvent('amp:load:start', 3)
        .then(function() {
  ...
  it('should resize and load more elements', () => {
    var p = fixture.awaitEvent('amp:load:start', 11)
                .then(function() {
                  expect(fixture.doc.querySelectorAll('amp-img img[src]'))
                      .to.have.length(11);
                  fixture.iframe.height = 2000;
                  fixture.win.dispatchEvent(new fixture.win.Event('resize'));
                  return fixture.awaitEvent('amp:load:start', 13)
                      .then(function() {
                        expect(fixture.doc.querySelectorAll('amp-img img[src]'))
                            .to.have.length(13);
                      });
  ...
  it('should respect media queries', () => {
    return fixture.awaitEvent('amp:load:start', 3)
        .then(function() {
          ...
          fixture.win.dispatchEvent(new fixture.win.Event('resize'));
          return fixture.awaitEvent('amp:load:start', 4)
              .then(function() {
                expect(smallScreen.className)
                    .to.match(/-amp-hidden-by-media-query/);
