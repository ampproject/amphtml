...
class TestConfig {
  ...
  constructor(runner) {
     ...
     */
    this.skip(this.platform.isIe.bind(this.platform));
  }
  ...
  enableIe() {
    this.skipMatchers.splice(
        this.skipMatchers.indexOf(this.platform.isIe.bind(this.platform)), 1);
    return this;
  }
  ...
  ifIe() {
    ...
    return this.enableIe().if(this.platform.isIe.bind(this.platform));
  }
