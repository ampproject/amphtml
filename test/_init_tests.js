...
chai.Assertion.addMethod('attribute', function(attr) {
  ...
  this.assert(obj.hasAttribute(attr),
      'expected element \'' + tagName + '\' to have attribute #{exp}',
      'expected element \'' + tagName + '\' to not have attribute #{act}', attr,
      attr);
});
...
chai.Assertion.addMethod('class', function(className) {
  var obj = this._obj;
  var tagName = obj.tagName.toLowerCase();
  this.assert(obj.classList.contains(className),
...
chai.Assertion.addProperty('visible', function() {
  ...
  var tagName = obj.tagName.toLowerCase();
  this.assert(value === 'visible',
      'expected element \'' + tagName +
          '\' to be #{exp}, got #{act}. with classes: ' + obj.className,
      'expected element \'' + tagName + '\' not to be #{act}. with classes: ' +
          obj.className,
      'visible', value);
});
...
chai.Assertion.addMethod('display', function(display) {
  ...
  var tagName = obj.tagName.toLowerCase();
  this.assert(value === display,
      'expected element \'' + tagName + '\' to be #{exp}, got #{act}.',
      'expected element \'' + tagName + '\' not to be #{act}.', display, value);
});
