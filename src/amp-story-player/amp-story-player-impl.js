...
import {EmbedMode, EmbedModeParam} from '../amp-story-embed-mode';
...
export class AmpStoryPlayer {
  ...
  constructor(win, element) {
    ...
    /** @private {boolean} */
    this.isAutoplaying_ = this.element_.hasAttribute('autoplay');
   ...
   * @private
   */
  layoutIframe_(story, iframe, visibilityState, embedMode = undefined) {
