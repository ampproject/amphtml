...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.ampproject.org/v0/bento-youtube-1.0.css">
  <script async custom-element="bento-youtube" src="https://cdn.ampproject.org/v0/bento-youtube-1.0.js"></script>
</head>
<body>
  <bento-youtube
...
The experimental `1.0` version of `bento-youtube` does not automatically convert `data-param-controls` to `controls`. Instead it takes `controls` directly as an attribute.
