 ...
 *
 * @param {!./DOM-rect.DOMRectDef} element The element's layout rectangle
 * @param {?./DOM-rect.DOMRectDef} owner The owner's layout rect, if
 *     there is an owner.
 * @param {!./DOM-rect.DOMRectDef} viewport The viewport's layout rect.
