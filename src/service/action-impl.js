...
export class ActionService {
  ...
  /**
   * Searches for the "amp-action-whitelist" meta tag, parses and returns its contents.
   * For email documents, the allowlist of actions is autogenerated and supercedes the meta tag.
   *
   * For example:
   ...
   */
  queryWhitelist_() {
    // Allow only the default actions for AMP4Email format documents.
