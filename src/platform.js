...
export class Platform {
  ...
  /**
   * Whether the current browser is a Facebook webview.
   * @return {boolean}
   */
  isFacebook() {
    return /FBAV/.test(this.navigator.userAgent);
  }

  /**
   * Whether the current browser is a Twitter webview.
   * @return {boolean}
   */
  isTwitter() {
    return /Twitter/.test(this.navigator.userAgent);
  }

  /**
   * Whether the current browser is a Pinterest webview.
   * @return {boolean}
   */
  isPinterest() {
    return /Pinterest/.test(this.navigator.userAgent);
  }
};
