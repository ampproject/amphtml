...
export class Services {
   ...
   */
  static storyParallaxService(win) {
    return (
      /** @type {?../extensions/amp-story/1.0/amp-story-parallax-service.AmpStoryParallaxService} */
      (getExistingServiceOrNull(win, 'story-parallax'))
    );
  }
