...
export class Services {
  ...
  /**
   * @param {!Element|!./service/ampdoc-impl.AmpDoc} elementOrAmpDoc
   * @return {!../extensions/amp-next-page/0.2/next-page-service.NextPageService}
   */
  static nextPageServiceForDoc(elementOrAmpDoc) {
    return /** @type {!../extensions/amp-next-page/0.2/next-page-service.NextPageService} */ (getServiceForDoc(
      elementOrAmpDoc,
      'next-page'
    ));
  }
