...
component with the `on` action. [/tip][/filter] <!-- formats="email" -->
...
for more details. [/filter]<!-- formats="websites, stories, ads" -->
...
See the guide on
[creating responsive AMP pages](https://amp.dev/documentation/guides-and-tutorials/develop/style_and_layout/responsive_design#displaying-responsive-images)
for more details. [/filter]<!-- formats="email" -->
...
example. [/filter]<!-- formats="websites, stories, ads" -->
