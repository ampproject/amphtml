...
installRuntimeServices } from "./service/core-services";

import { stubElementsForDoc } from "./service/custom-element-registry";
import {
installExtensionsService,
stubLegacyElements } from "./service/extensions-impl";
...
export function adoptShadowMode(global) {
  return adoptShared(global, function (global, extensions) {
    ...
    var manager = new MultidocManager(
    global,
...
function maybeLoadCorrectVersion(win, fnOrStruct) {
  if (false && isExperimentOn(win, 'disable-version-locking')) {
    return false;
  }
  if (typeof fnOrStruct == 'function') {
    return false;
