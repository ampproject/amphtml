...
var _ref = timeago.default || timeago,format = _ref.format,register = _ref.register;
export { format };
...
export function getLocale(locale) {
  ...
  locale.length === 5 /* with '-|_' */)
    {
      return "".concat(locale.slice(0, 2), "_").concat(locale.slice(-2).toUpperCase());
    }
  return locale;
}
...
var nonStandardReplacements = {
  ...
  'inid': 'id_ID',
  'inhi': 'hi_IN' };
// /Users/mszylkowski/src/amphtml/extensions/amp-timeago/1.0/locales.js