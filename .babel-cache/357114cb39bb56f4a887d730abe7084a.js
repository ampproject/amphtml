...
export var VisibilityModel = /*#__PURE__*/function () {
   ...
   */
  function VisibilityModel(spec, calcVisibility) {var _this = this;_classCallCheck(this, VisibilityModel);
    /** @const @private */
   ...
   * @private
   */_createClass(VisibilityModel, [{ key: "reset_", value:
    function reset_() {var _this2 = this;
      devAssert(
      !this.eventResolver_);
     ...
     */ }, { key: "onTriggerEvent", value:
    function onTriggerEvent(handler) {
      if (this.onTriggerObservable_) {
     ...
     */ }, { key: "setReportReady", value:
    function setReportReady(callback) {
     ...
     * @private
     */ }, { key: "update_", value:
    function update_(visibility) {var _this3 = this;
     ...
     * @param {number} visibility
     * @return {boolean}
     */ }, { key: "isVisibilityMatch_", value:
    function isVisibilityMatch_(visibility) {
      devAssert(
     ...
     * @return {boolean} true
     * @private
     */ }, { key: "updateCounters_", value:
    function updateCounters_(visibility) {
      devAssert(
      visibility >= 0 && visibility <= 1);
      ...
      var timeSinceLastUpdate = this.lastVisibleUpdateTime_ ?
     ...
     * page loading.
     * @param {number} depth
     */ }, { key: "maybeSetInitialScrollDepth", value:
    function maybeSetInitialScrollDepth(depth) {
     ...
     * ini-load.
     * @return {number} depth
     */ }, { key: "getInitialScrollDepth", value:
    function getInitialScrollDepth() {
     ...
     * @return {time}
     * @private
     */ }, { key: "computeTimeToWait_", value:
    function computeTimeToWait_() {
      var waitForContinuousTime = Math.max(
      this.spec_['continuousTimeMin'] - this.continuousTime_,
      0);

      var waitForTotalTime = Math.max(
