...
export function sequentialIdGenerator() {
  var counter = 0;
  return function () {return String(++counter);};
}
...
export function randomIdGenerator(maxValue) {
  return function () {return String(Math.floor(Math.random() * maxValue));};
}
// /Users/mszylkowski/src/amphtml/src/core/data-structures/id-generator.js