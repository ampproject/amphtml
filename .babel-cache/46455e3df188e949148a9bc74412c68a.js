 ...
 */
export function setCookie(win, name, value, expirationTime) {var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
...
function getSameSiteString(win, sameSite) {
  ...
  return "; SameSite=".concat(sameSite);
}
...
function checkOriginForSettingCookie(win, options, name) {
  ...
  userAssert(
  !isProxyOrigin(win.location.href), "Should never attempt to set cookie on proxy origin: ".concat(
  name));
