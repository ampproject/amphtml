 ...
 */var
Bezier = /*#__PURE__*/function () {function Bezier() {_classCallCheck(this, Bezier);}_createClass(Bezier, null, [{ key: "solveYValueFromXValue", value:
    /**
     ...
     * @private
     */ }, { key: "solvePositionFromXValue_", value:
    function solvePositionFromXValue_(xVal, x0, x1, x2, x3) {
     ...
     * @private
     */ }, { key: "getPointX_", value:
    function getPointX_(t, x0, x1, x2, x3) {
     ...
     * @return {number} The computed coordinate.
     * @private
     */ }, { key: "getPointY_", value:
    function getPointY_(t, y0, y1, y2, y3) {
      // Special case start and end.
      if (t == 0) {
        return y0;
      } else if (t == 1) {
