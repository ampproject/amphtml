 ...
 * @interface
 */
export var MutatorInterface = /*#__PURE__*/function () {function MutatorInterface() {_classCallCheck(this, MutatorInterface);}_createClass(MutatorInterface, [{ key: "forceChangeSize", value:
    /**
     ...
     */ }, { key: "requestChangeSize", value:
    function requestChangeSize(element, newHeight, newWidth, opt_newMargins, opt_event) {}

    /**
     * Expands the element.
     * @param {!Element} element
     */ }, { key: "expandElement", value:
    ...
    function measureMutateElement(element, measurer, mutator) {} }]);return MutatorInterface;}();
