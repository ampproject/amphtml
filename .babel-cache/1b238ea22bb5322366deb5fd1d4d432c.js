...
export var BaseElement = /*#__PURE__*/function () {
  ...
  function BaseElement(element) {_classCallCheck(this, BaseElement);
   ...
   */_createClass(BaseElement, [{ key: "signals", value:
    function signals() {
    ...
    function updateLayoutPriority(newLayoutPriority) {
      this.element.
      getResources().
      updateLayoutPriority(this.element, newLayoutPriority);
    }

    /** @return {!Layout} */ }, { key: "getLayout", value:
    function getLayout() {
     ...
     * TODO(#31915): remove once R1 migration is complete.
     */ }, { key: "preconnectCallback", value:
    function preconnectCallback(opt_onLayout) {
      // Subclasses may override.
    }
     ...
     */ }, { key: "setAsContainer", value:
    function setAsContainer(opt_scroller) {
      this.element.setAsContainerInternal(opt_scroller);
    }

    /**
     * Removes itself as a container. See `setAsContainer`.
     */ }, { key: "removeAsContainer", value:
    function removeAsContainer() {
     ...
     * @return {?Element}
     */ }, { key: "createPlaceholderCallback", value:
    function createPlaceholderCallback() {
      return null;
    }
    ...
    function setReadyState(state, opt_failure) {
     ...
     * @return {?Promise|undefined}
     */ }, { key: "mountCallback", value:
    function mountCallback(opt_abortSignal) {}

    /**
     * Unload heavy elements, remove global listeners, etc.
     */ }, { key: "unmountCallback", value:
     ...
     * @return {boolean}
     * TODO(#31915): remove once R1 migration is complete.
     */ }, { key: "unlayoutOnPause", value:
    function unlayoutOnPause() {
      return false;
    }
     ...
     * @public
     */ }, { key: "registerAction", value:
    function registerAction(alias, handler) {var minTrust = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ActionTrust.DEFAULT;
      initActionMap(this);
      this['actionMap_'][alias] = { handler: handler, minTrust: minTrust };
    }
     ...
     * @param {ActionTrust=} minTrust
     * @public
     */ }, { key: "registerDefaultAction", value:
    function registerDefaultAction(
    handler)


    {var alias = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_ACTION;var minTrust = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ActionTrust.DEFAULT;
      devAssert(
     ...
     */ }, { key: "executeAction", value:
    function executeAction(invocation, unusedDeferred) {
      ...
      userAssert(holder, "Method not found: ".concat(method, " in ").concat(tagName));
     ...
     * @public @final
     * @return {!UnlistenDef}
     */ }, { key: "forwardEvents", value:
    function forwardEvents(events, element) {var _this = this;
      var unlisteners = (isArray(events) ? events : [events]).map(function (eventType) {return (
          listen(element, eventType, function (event) {
            dispatchCustomEvent(_this.element, eventType, getData(event) || {});
          }));});


      return function () {return unlisteners.forEach(function (unlisten) {return unlisten();});};
    }
     ...
     * @return {!./layout-rect.LayoutRectDef}
     */ }, { key: "getIntersectionElementLayoutBox", value:
    function getIntersectionElementLayoutBox() {
     ...
     * @public
     */ }, { key: "forceChangeHeight", value:
    function forceChangeHeight(newHeight) {
     ...
     * @return {!Promise}
     * @public
     */ }, { key: "attemptChangeHeight", value:
    function attemptChangeHeight(newHeight) {
     ...
     * @return {!Promise}
     * @public
     */ }, { key: "attemptChangeSize", value:
    function attemptChangeSize(newHeight, newWidth, opt_event) {
      return Services.mutatorForDoc(this.getAmpDoc()).requestChangeSize(
      this.element,
      newHeight,
      newWidth,
     ...
     * @return {!Promise}
     */ }, { key: "mutateElement", value:
    function mutateElement(mutator, opt_element) {
     ...
     * @param {Element=} opt_element
     * @return {!Promise}
     */ }, { key: "measureMutateElement", value:
    function measureMutateElement(measurer, mutator, opt_element) {
     ...
     * @param {function()} mutator
     * @return {!Promise}
     */ }, { key: "mutateElementSkipRemeasure", value:
    function mutateElementSkipRemeasure(mutator) {
    ...
    function collapsedCallback(unusedElement) {
      // Subclasses may override.
    }
    ...
    function mutatedAttributesCallback(unusedMutations) {
      // Subclasses may override.
    }
     ...
     * @return {boolean}
     * @nocollapse
     */ }, { key: "deferredMount", value: function deferredMount(unusedElement) {return true;} /**
     ...
     * @return {boolean}
     * @nocollapse
     */ }, { key: "prerenderAllowed", value: function prerenderAllowed(unusedElement) {return false;} /**
     ...
     * @return {boolean}
     * @nocollapse
     */ }, { key: "usesLoading", value: function usesLoading(unusedElement) {return false;} /**
     ...
     * }}
     * @nocollapse
     */ }, { key: "createLoaderLogoCallback", value: function createLoaderLogoCallback(unusedElement) {return {};} /**
     ...
     * @return {number}
     * @nocollapse
     */ }, { key: "getBuildPriority", value: function getBuildPriority(unusedElement) {return LayoutPriority.CONTENT;} /**
     * Called by the framework to give the element a chance to preconnect to
     * hosts and prefetch resources it is likely to need. May be called
     * multiple times because connections can time out.
     *
     ...
     * @return {?Array<string>}
     * @nocollapse
     */ }, { key: "getPreconnects", value: function getPreconnects(unusedElement) {return null;} /**
     ...
     * @return {boolean}
     * @nocollapse
     */ }, { key: "requiresShadowDom", value: function requiresShadowDom() {return false;} }]);return BaseElement;}(); /**
 ...
 */function initActionMap(baseElement) {if (!baseElement['actionMap_']) {baseElement['actionMap_'] = baseElement.win.Object.create(null);}}
