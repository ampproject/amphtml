...
export var AnalyticsConfig = /*#__PURE__*/function () {
   ...
   */
  function AnalyticsConfig(element) {_classCallCheck(this, AnalyticsConfig);
    /** @private {!Element} */
   ...
   */_createClass(AnalyticsConfig, [{ key: "loadConfig", value:
    function loadConfig() {var _this = this;
      ...
      then(function () {return _this.config_;});
    }
     ...
     */ }, { key: "getVendorUrl_", value:
    function getVendorUrl_(vendor) {
      var baseUrl = calculateScriptBaseUrl(
      this.win_.location, false);


      // bg has a special canary config
      var canary = vendor === 'bg' && isCanary(self) ? '.canary' : '';
      return "".concat(baseUrl, "/rtv/").concat(
      getMode().rtvVersion, "/v0/analytics-vendors/").concat(
      vendor).concat(canary, ".json");
    }
     ...
     */ }, { key: "fetchVendorConfig_", value:
    function fetchVendorConfig_() {var _this2 = this;
     ...
     * @private
     * @return {!Promise<undefined>}
     */ }, { key: "fetchRemoteConfig_", value:
    function fetchRemoteConfig_() {var _this3 = this;
      ...
      then(function (expandedUrl) {
        ...
        return Services.xhrFor(toWin(_this3.win_)).fetchJson(
        remoteConfigUrl,
        fetchConfig);
     ...
     * @private
     * @return {!Promise<undefined>}
     */ }, { key: "processConfigs_", value:
    function processConfigs_() {
     ...
     * @return {!Promise<undefined>}
     */ }, { key: "handleConfigRewriter_", value:
    function handleConfigRewriter_(config, configRewriterUrl) {var _this4 = this;
      ...
      return this.handleVarGroups_(config).then(function () {
        ...
        if (_this4.element_.hasAttribute('data-credentials')) {
          ...
          _this4.element_.getAttribute('data-credentials');
        }
        return (
        Services.urlReplacementsForDoc(_this4.element_)
        // Pass bindings if requested
        .expandUrlAsync(configRewriterUrl).
        then(function (expandedUrl) {
          return Services.xhrFor(toWin(_this4.win_)).fetchJson(
          expandedUrl,
          fetchConfig);
     ...
     * remove the property.
     * @private
     */ }, { key: "checkWarningMessage_", value:
    function checkWarningMessage_() {
     ...
     * @return {!Promise}
     */ }, { key: "handleVarGroups_", value:
    function handleVarGroups_(pubConfig) {var _this5 = this;
      ...
      Object.keys(mergedConfig).forEach(function (groupName) {
        ...
        var groupPromise = _this5.shallowExpandObject(_this5.element_, group).then(
     ...
     * @return {!JsonObject}
     */ }, { key: "mergeConfigs_", value:
    function mergeConfigs_(rewrittenConfig) {
     ...
     * @return {!JsonObject}
     */ }, { key: "getConfigRewriter_", value:
    function getConfigRewriter_() {
     ...
     */ }, { key: "validateTransport_", value:
    function validateTransport_(inlineConfig) {
    ...
    function shallowExpandObject(element, obj) {
      ...
      return Promise.all(expansionPromises).then(function (expandedValues) {
        keys.forEach(function (key, i) {return (expandedObj[key] = expandedValues[i]);});
        return expandedObj;
      });
