...
scaleAndTranslate,
translate2d,
whooshIn } from "./animation-presets-utils";
...
/** @const {!Array<string>} */
export var PRESET_OPTION_ATTRIBUTES = [
 ...
 */
var FULL_BLEED_ANIMATION_NAMES = [
'pan-up',
'pan-down',
'pan-right',
'pan-left',
 ...
 */
var ANIMATION_CSS_CLASS_NAMES = _defineProperty({},
FULL_BLEED_CATEGORY,
...
export var presets = {
  ...
  'rotate-in-left': {
    duration: 1000,
    easing: "cubic-bezier(".concat(DEFAULT_CURVE, ")"),
    keyframes: function keyframes(dimensions) {
      var offsetX = -(dimensions.targetX + dimensions.targetWidth);
  ...
  'drop': {
    ...
    keyframes: function keyframes(dimensions) {
      ...
      {
        offset: 0.0,
        transform: "translateY(".concat(px(Number(-maxBounceHeight)), ")"),
      ...
      {
        offset: 0.45,
        transform: "translateY(".concat(px(-maxBounceHeight * 0.2812), ")"),
        easing: 'cubic-bezier(.5, 0, 1, 1)' },
      ...
      {
        offset: 0.71,
        transform: "translateY(".concat(px(-maxBounceHeight * 0.0956), ")"),
        easing: 'cubic-bezier(.5, 0, 1, 1)' },
      ...
      {
        offset: 0.85,
        transform: "translateY(".concat(px(-maxBounceHeight * 0.0359), ")"),
        easing: 'cubic-bezier(.5, 0, 1, 1)' },
      ...
      {
        offset: 0.96,
        transform: "translateY(".concat(px(-maxBounceHeight * 0.0156), ")"),
        easing: 'cubic-bezier(.5, 0, 1, 1)' },
  ...
  'zoom-in': {
    ...
    keyframes: function keyframes(unusedDimensions, options) {
      ...
      return [
      { transform: "scale(".concat(scaleStart || SCALE_LOW_DEFAULT, ")") },
      { transform: "scale(".concat(scaleEnd || SCALE_HIGH_DEFAULT, ")") }];
  ...
  'zoom-out': {
    ...
    keyframes: function keyframes(unusedDimensions, options) {
      ...
      return [
      { transform: "scale(".concat(scaleStart || SCALE_HIGH_DEFAULT, ")") },
      { transform: "scale(".concat(scaleEnd || SCALE_LOW_DEFAULT, ")") }];
