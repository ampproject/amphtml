...
opt_evtListenerOpts)
{
  ...
  var wrapped = function wrapped(event) {
    ...
    } catch (e) {var _self$__AMP_REPORT_ER, _self;
      // __AMP_REPORT_ERROR is installed globally per window in the entry point.
      ((_self$__AMP_REPORT_ER = (_self = self).__AMP_REPORT_ERROR) === null || _self$__AMP_REPORT_ER === void 0) ? (void 0) : _self$__AMP_REPORT_ER.call(_self, e);
      throw e;
    }
  };
  var optsSupported = detectEvtListenerOptsSupport();
  var capture = !!((opt_evtListenerOpts !== null && opt_evtListenerOpts !== void 0) && opt_evtListenerOpts.capture);
  ...
  return function () {var _localElement;
    ((_localElement = localElement) === null || _localElement === void 0) ? (void 0) : _localElement.removeEventListener(
    eventType,
    wrapped,
    optsSupported ? opt_evtListenerOpts : capture);
