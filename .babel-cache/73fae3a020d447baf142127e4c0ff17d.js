 ...
 */var
LoaderBuilder = /*#__PURE__*/function () {
  /**
   ...
   */
  function LoaderBuilder(element, domRoot, elementWidth, elementHeight) {_classCallCheck(this, LoaderBuilder);
   ...
   */_createClass(LoaderBuilder, [{ key: "build", value:
    function build() {
     ...
     * certain heuristics.
     */ }, { key: "maybeAddLoaderAnimation_", value:
    function maybeAddLoaderAnimation_() {
     ...
     * @private
     */ }, { key: "hasBackgroundContent_", value:
    function hasBackgroundContent_() {
     ...
     * element.
     * @private
     */ }, { key: "tagNeedsBackground_", value:
    function tagNeedsBackground_() {
     ...
     * and tagName.
     * @private
     */ }, { key: "maybeAddLoadingBackground_", value:
    function maybeAddLoadingBackground_() {
     ...
     * }}
     */ }, { key: "getCustomLogo_", value:
    function getCustomLogo_() {
      if (this.isAd_()) {
        return {
     ...
     * @private
     */ }, { key: "getVideoPlayerLogo_", value:
    function getVideoPlayerLogo_() {
     ...
     * @return {!Element}
     * @private
     */ }, { key: "getDefaultLogo_", value:
    function getDefaultLogo_() {
      var html = htmlFor(this.element_);
      return html(_template4);
     ...
     * @return {!Element}
     * @private
     */ }, { key: "getAdsLogo_", value:
    function getAdsLogo_() {
      var html = htmlFor(this.element_);
      return html(_template5);
     ...
     * @return {boolean}
     */ }, { key: "hasBlurryImagePlaceholder_", value:
    function hasBlurryImagePlaceholder_() {
     ...
     * @private
     * @return {boolean}
     */ }, { key: "requiresBackgroundShim_", value:
    function requiresBackgroundShim_() {
     ...
     * @private
     * @return {boolean}
     */ }, { key: "requiresLargeSpinner_", value:
    function requiresLargeSpinner_() {
      // Not Implemented
      return false;
    } }]);return LoaderBuilder;}();


export var LoaderService = /*#__PURE__*/function () {function LoaderService() {_classCallCheck(this, LoaderService);}_createClass(LoaderService, [{ key: "initializeLoader", value:
    /**
     * @param {!AmpElement} element
    ...
    elementHeight)
    {
      ...
      setImportantStyles(element, {
        '--loader-delay-offset': "".concat(loaderDelay, "ms") });
