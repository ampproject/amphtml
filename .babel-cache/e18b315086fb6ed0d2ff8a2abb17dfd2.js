...
function insertStyleElement(cssRoot, cssText, isRuntimeCss, ext) {
  ...
  var key = isRuntimeCss ?
  'amp-runtime' :
  isExtCss ? "amp-extension=".concat(
  ext) :
  null;
...
function getExistingStyleElement(cssRoot, styleMap, key) {
  ...
  var existing = cssRoot. /*OK*/querySelector("style[".concat(key, "]"));
  if (existing) {
...
function setBodyVisibleStyles(doc) {
  setStyles( /** @type {!Element} */(doc.body), {
    opacity: 1,
    visibility: 'visible',
    'animation': 'none' });
