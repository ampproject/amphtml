...
var DEFAULT_DIMENSION = 24;
var DEFAULT_PADDING = 16;

var TOP_BAR_HEIGHT_LARGE = 80;
var DEFAULT_DIMENSION_LARGE = 40;
var DEFAULT_PADDING_LARGE = 20;

var DEFAULT_GRID_PADDING = 5;
export var PADDING_ALLOWANCE = 40;
...
var controlsPanel = {
  position: 'absolute !important',
  height: "".concat(TOP_BAR_HEIGHT, "px !important"),
  width: '100% !important',
  zIndex: '1',
  background: 'linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0))',
  '@media (min-width:1024px)': {
    height: "".concat(TOP_BAR_HEIGHT_LARGE, "px !important") } };
...
var grid = {
  ...
  gridGap: "".concat(DEFAULT_GRID_PADDING, "px !important"),
  gridTemplateColumns: 'repeat(3, 1fr)',
  gridAutoRows: 'min-content !important',
  padding: "0px ".concat(DEFAULT_GRID_PADDING, "px !important"),
  top: "".concat(TOP_BAR_HEIGHT, "px !important"),
  height: "calc(100% - ".concat(TOP_BAR_HEIGHT, "px) !important"),
  width: 'calc(100% - 10px) !important',
  '@media (min-width: 1024px)': {
    gridTemplateColumns: "repeat(4, calc(1024px/4 - ".concat(DEFAULT_GRID_PADDING, "px * 5 / 4))"),
    top: "".concat(TOP_BAR_HEIGHT_LARGE, "px !important"),
    height: "calc(100% - ".concat(TOP_BAR_HEIGHT_LARGE, "px) !important") } };
...
var caption = {
   ...
   * collapsed.
   */
  paddingTop: "".concat(PADDING_ALLOWANCE, "px !important"),
  overflow: 'hidden',
  '&$auto': {
