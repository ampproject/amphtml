...
var ElementPredicate_1_0_Def; // eslint-disable-line google-camelcase/google-camelcase
 ...
 * }}
 */
var AmpStoryLogType_1_0_Def; // eslint-disable-line google-camelcase/google-camelcase
...
function getPosterFromVideo(el) {
  return new Promise(function (resolve, reject) {
    ...
    poster.onload = function () {return resolve(poster);};
...
var LogType = {
  ...
  IMAGES_MAX_720P_OR_SRCSET: {
    ...
    predicate: function predicate(el) {return el.naturalWidth <= 720 && el.naturalHeight <= 1280;},
    level: LogLevel.WARN },
  ...
  IMAGES_PORTRAIT: {
    ...
    predicate: function predicate(el) {return el.naturalWidth < el.naturalHeight;},
    level: LogLevel.WARN },
  ...
  VIDEOS_MAX_720P: {
    ...
    selector: 'video',
    predicate: function predicate(el) {return el.videoWidth <= 720 && el.videoHeight <= 1280;},
    level: LogLevel.WARN },
  ...
  VIDEOS_PORTRAIT: {
    ...
    predicate: function predicate(el) {return el.videoWidth < el.videoHeight;},
    level: LogLevel.WARN },
  ...
  VIDEO_POSTER_MAX_720P: {
    ...
    predicate: function predicate(el) {return (
        getPosterFromVideo(el).then(function (poster) {
  ...
  VIDEO_POSTER_POTRAIT: {
    ...
    predicate: function predicate(el) {return (
        ...
        function (poster) {return poster.naturalWidth < poster.naturalHeight;}));},
...
function getLogEntry(rootElement, logType, element) {
  var predicate = logType.predicate || (function (unusedEl) {return false;});

  return tryResolve(function () {return predicate(element);}).then(function (conforms) {
...
function getLogEntriesForType(rootElement, logType) {
  var precondition = logType.precondition || (function (unusedEl) {return true;});

  var elements = logType.selector ?
