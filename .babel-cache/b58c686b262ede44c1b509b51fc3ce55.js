 ...
 * @interface
 */
export var VideoInterface = /*#__PURE__*/function () {function VideoInterface() {_classCallCheck(this, VideoInterface);}_createClass(VideoInterface, [{ key: "signals", value:
    /**
     * See `BaseElement`.
    ...
    function mutateElementSkipRemeasure(unusedMutator) {}
     ...
     *
     * @return {boolean}
     */ }, { key: "preimplementsAutoFullscreen", value:
     ...
     *
     * @return {boolean}
     */ }, { key: "preimplementsMediaSessionAPI", value:
     ...
     */ }, { key: "seekTo", value:
    function seekTo(unusedTimeSeconds) {} }]);return VideoInterface;}();
...
export function delegateAutoplay(video) {
  whenUpgradedToCustomElement( /** @type {!Element} */(video)).then(function (el) {
