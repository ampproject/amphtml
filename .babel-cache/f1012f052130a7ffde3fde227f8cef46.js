 ...
 */
export function upgradeBackgroundAudio(element) {var loop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  if (!element.hasAttribute('background-audio')) {
    return null;
  }
  var audioEl = element.ownerDocument.createElement('audio');
  var audioSrc = Services.urlForDoc(element).assertHttpsUrl(
