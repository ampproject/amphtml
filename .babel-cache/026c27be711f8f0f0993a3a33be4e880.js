...
export function getBootstrapUrl(type) {
  ...
  return "".concat(urls.thirdParty, "/").concat(mode.version(), "/vendor/").concat(type).concat(extension);
}
...
export function getDefaultBootstrapBaseUrl(parentWindow, opt_srcFileBasename) {
  ...
  urls.thirdPartyFrameHost, "/").concat(mode.version(), "/") + "".concat(
...
export function getDevelopmentBootstrapBaseUrl(parentWindow, srcFileBasename) {
  ...
  mode.version(), "/").concat(srcFileBasename) : "current/".concat(
  srcFileBasename, ".max")) +
  '.html');
...
opt_strictForUnitTest)
{
  ...
  return "".concat(url, "?").concat(mode.version());
}
