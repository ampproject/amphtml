...
export function domFingerprintPlain(element) {
  ...
  while (isElement(element) && level < 25) {
    ...
    ids.push("".concat(nodeName).concat(id).concat(indexWithinParent(element)));
    level++;
...
export var DomFingerprint = /*#__PURE__*/function () {function DomFingerprint() {_classCallCheck(this, DomFingerprint);}_createClass(DomFingerprint, null, [{ key: "generate", value:
    /**
...
function indexWithinParent(element) {
  ...
  return count < 25 && i < 100 ? ".".concat(count) : '';
}
