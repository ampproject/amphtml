...
export function getDimension(axis, el) {
  ...
  el. /*OK*/getBoundingClientRect(),bottom = _el$getBoundingClient.bottom,height = _el$getBoundingClient.height,left = _el$getBoundingClient.left,right = _el$getBoundingClient.right,top = _el$getBoundingClient.top,width = _el$getBoundingClient.width;
...
// /Users/mszylkowski/src/amphtml/extensions/amp-base-carousel/1.0/dimensions.js