...
export function createShadowRoot(hostElement) {
  ...
  if (!isShadowCssSupported()) {
    var rootId = "i-amphtml-sd-".concat(win.Math.floor(win.Math.random() * 10000));
...
function createShadowRootPolyfill(hostElement) {
  ...
  shadowRoot.getElementById = function (id) {
    ...
    return (/** @type {?HTMLElement} */(
      shadowRoot. /*OK*/querySelector("#".concat(escapedId))));
  ...
  Object.defineProperty(shadowRoot, 'styleSheets', {
    get: function get() {
      ...
      return toArray(doc.styleSheets).filter(function (styleSheet) {return (
...
export function scopeShadowCss(shadowRoot, css) {
  ...
  return scopeRules.call(ShadowCSS, rules, ".".concat(id), transformRootSelectors);
}
...
function getStylesheetRules(doc, css) {
  var style = /** @type {!HTMLStyleElement} */(doc.createElement('style'));
