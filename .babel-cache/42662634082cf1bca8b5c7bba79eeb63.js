...
/** @const {string} */
export var BIND_PREFIX = 'data-amp-bind-';

/** @const {string} */
export var DIFF_KEY = 'i-amphtml-key';

/** @const {string} */
export var DIFF_IGNORE = 'i-amphtml-ignore';
 ...
 */
export var DIFFABLE_AMP_ELEMENTS = {
 ...
 */
export var EMAIL_ALLOWLISTED_AMP_TAGS = {
  'amp-accordion': true,
  'amp-anim': true,
  'amp-bind-macro': true,
  'amp-carousel': true,
 ...
 * @const {!Array<string>}
 */
export var TRIPLE_MUSTACHE_ALLOWLISTED_TAGS = [
'a',
'amp-img',
'article',
'aside',
 ...
 * @const {!Object<string, !Array<string>>}
 */
export var ALLOWLISTED_ATTRS_BY_TAGS = {
  'a': ['rel', 'target'],
  'div': ['template'],
...
/** @const {!Array<string>} */
export var ALLOWLISTED_TARGETS = ['_top', '_blank'];
...
var DENYLISTED_TAG_SPECIFIC_ATTR_VALUES = Object.freeze(
dict({
  'input': {
    'type': /(?:image|button)/i } }));
 ...
 * @const {!Object<string, !Object<string, !RegExp>>}
 */
var EMAIL_DENYLISTED_TAG_SPECIFIC_ATTR_VALUES = Object.freeze(
dict({
  'input': {
...
/** @const {!Array<string>} */
var DENYLISTED_FIELDS_ATTR = Object.freeze([
'form',
'formaction',
'formmethod',
'formtarget',
...
/** @const {!Object<string, !Array<string>>} */
var DENYLISTED_TAG_SPECIFIC_ATTRS = Object.freeze(
dict({
 ...
 * @const {!Object<string, !Array<string>>}
 */
var EMAIL_DENYLISTED_TAG_SPECIFIC_ATTRS = Object.freeze(
dict({
  'amp-anim': ['controls'],
  'form': ['name'] }));
 ...
 * @const {!RegExp}
 */
var INVALID_INLINE_STYLE_REGEX =
...
{var opt_purify = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var attrValueWithoutWhitespace = attrValue ?
  ...
  var attrDenylist = Object.assign(
  map(),
  ...
  var attrValueDenylist = Object.assign(
  map(),
...
// /Users/mszylkowski/src/amphtml/src/purifier/sanitation.js