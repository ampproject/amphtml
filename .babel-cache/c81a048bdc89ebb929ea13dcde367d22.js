...
export var Signals = /*#__PURE__*/function () {
   ...
   */
  function Signals() {_classCallCheck(this, Signals);
    /**
   ...
   */_createClass(Signals, [{ key: "get", value:
    function get(name) {
     ...
     */ }, { key: "whenSignal", value:
    function whenSignal(name) {var _this$promiseMap_;
      var promiseStruct = ((_this$promiseMap_ = this.promiseMap_) === null || _this$promiseMap_ === void 0) ? (void 0) : _this$promiseMap_[name];
      if (!promiseStruct) {
     ...
     */ }, { key: "signal", value:
    function signal(name, opt_time) {var _this$promiseMap_2;
      if (this.map_[name] != null) {
        // Do not duplicate signals.
        return;
      }
      var time = opt_time !== null && opt_time !== void 0 ? opt_time : Date.now();
      this.map_[name] = time;
      var promiseStruct = ((_this$promiseMap_2 = this.promiseMap_) === null || _this$promiseMap_2 === void 0) ? (void 0) : _this$promiseMap_2[name];
      if ((promiseStruct !== null && promiseStruct !== void 0) && promiseStruct.resolve) {
     ...
     * @param {string} name
     * @param {!Error} error
     */ }, { key: "rejectSignal", value:
    function rejectSignal(name, error) {var _this$promiseMap_3;
      if (this.map_[name] != null) {
        // Do not duplicate signals.
        return;
      }
      this.map_[name] = error;
      var promiseStruct = ((_this$promiseMap_3 = this.promiseMap_) === null || _this$promiseMap_3 === void 0) ? (void 0) : _this$promiseMap_3[name];
      if ((promiseStruct !== null && promiseStruct !== void 0) && promiseStruct.reject) {
     ...
     * @param {string} name
     */ }, { key: "reset", value:
    function reset(name) {var _this$promiseMap_4;
      if (this.map_[name]) {
        delete this.map_[name];
      }
      // Reset promise it has already been resolved.
      var promiseStruct = ((_this$promiseMap_4 = this.promiseMap_) === null || _this$promiseMap_4 === void 0) ? (void 0) : _this$promiseMap_4[name];
