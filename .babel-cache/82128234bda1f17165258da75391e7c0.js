...
export var getVimeoOriginRegExp = function getVimeoOriginRegExp() {return (
...
export function getVimeoIframeSrc(videoid, autoplay, doNotTrack) {
  return addParamsToUrl("https://player.vimeo.com/video/".concat(
 ...
 * @return {string}
 */
export function makeVimeoMessage(method) {var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
...
// /Users/mszylkowski/src/amphtml/extensions/amp-vimeo/vimeo-api.js