 ...
 * @return {string}
 */
var messageUrlRtv = function messageUrlRtv() {return "01".concat(internalRuntimeVersion());};
...
export var Log = /*#__PURE__*/function () {
   ...
   * @return {!LogLevel}
   * @private
   */_createClass(Log, [{ key: "getLevel_", value:
    function getLevel_() {
     ...
     * @return {!LogLevel}
     * @private
     */ }, { key: "defaultLevel_", value:
    function defaultLevel_() {
    ...
    function defaultLevelWithFunc_() {
      ...
      return this.levelFunc_(parseInt(getMode().log, 10), false);
    }
     ...
     */ }, { key: "msg_", value:
    function msg_(tag, level, messages) {
    ...
    function expandMessageArgs_(parts) {
      ...
      return ["More info at ".concat(externalMessageUrl(id, parts))];
    } }]);return Log;}();
