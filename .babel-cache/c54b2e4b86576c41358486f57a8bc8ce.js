...
import {
installStub,
shouldLoadPolyfill } from "./stubs/intersection-observer-stub";
...
export function installForChildWin(parentWin, childWin) {
  if (shouldLoadPolyfill(childWin)) {
    Object.defineProperties(childWin, {
      IntersectionObserver: { get: function get() {return parentWin.IntersectionObserver;} },
      IntersectionObserverEntry: {
        get: function get() {return parentWin.IntersectionObserverEntry;} } });
