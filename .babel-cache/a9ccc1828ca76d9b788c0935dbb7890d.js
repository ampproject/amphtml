...
var useCallback = Preact.useCallback,useEffect = Preact.useEffect,useMemo = Preact.useMemo,useRef = Preact.useRef,useState = Preact.useState;
 ...
 */
function WordPressEmbedWithRef(_ref,

ref)
{var requestResize = _ref.requestResize,_ref$title = _ref.title,title = _ref$title === void 0 ? 'WordPressEmbed' : _ref$title,url = _ref.url,rest = _objectWithoutProperties(_ref, _excluded);
  ...
  var _useState5 = useState(null),_useState6 = _slicedToArray(_useState5, 2),win = _useState6[0],setWin = _useState6[1];

  var iframeURL = useMemo(function () {
    return addParamToUrl(url, 'embed', 'true');
  }, [url]);

  var matchesMessagingOrigin = useCallback(
  function (testURL) {
    var embeddedUrl = new URL(url);
    var checkedUrl = new URL(testURL);
  ...
  useEffect(function () {var _contentRef$current, _contentRef$current$o;
    setWin(((_contentRef$current = contentRef.current) === null || _contentRef$current === void 0) ? (void 0) : ((_contentRef$current$o = _contentRef$current.ownerDocument) === null || _contentRef$current$o === void 0) ? (void 0) : _contentRef$current$o.defaultView);
  }, []);
...
var WordPressEmbed = forwardRef(WordPressEmbedWithRef);
...
// /Users/mszylkowski/src/amphtml/extensions/amp-wordpress-embed/1.0/component.js