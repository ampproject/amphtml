 ...
 * @return {boolean}
 */
export function isLocalDev(opt_win) {var _self$AMP_CONFIG;
  if (isProd()) {
    return false;
  }

  return !!(((_self$AMP_CONFIG = self.AMP_CONFIG) !== null && _self$AMP_CONFIG !== void 0) && _self$AMP_CONFIG.localDev) || isTest(opt_win);
}
