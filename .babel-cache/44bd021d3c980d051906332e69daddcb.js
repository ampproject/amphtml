 ...
 * @interface
 */
export var Disposable = /*#__PURE__*/function () {function Disposable() {_classCallCheck(this, Disposable);}_createClass(Disposable, [{ key: "dispose", value:
    /**
     * Instructs the service to release any resources it might be holding. Can
     * be called only once in the lifecycle of a service.
     */
    function dispose() {} }]);return Disposable;}();
...
export function assertDisposable(service) {
  devAssert(isDisposable(service));
...
function disposeServicesInternal(holder) {
  var services = getServices(holder);var _loop = function _loop(
  id) {
    ...
    if (serviceHolder.obj) {
      ...
      serviceHolder.promise.then(function (instance) {return (
          disposeServiceInternal(id, instance));});

    }};for (var id in services) {var _ret = _loop(id);if (_ret === "continue") continue;
  }
}
