...
{var _self$__AMP_REPORT_ER, _self;var opt_message = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Assertion failed';var var_args = arguments.length > 3 ? arguments[3] : undefined;
  if (shouldBeTruthy) {
  ...
  error.messageArray = remove(messageArray, function (x) {return x !== '';});
...
opt_message)
{
  if (isArray(opt_message)) {
    ...
    assertFn(shouldBeTruthy, "".concat(opt_message || defaultMessage, ": %s"), subject);
  }
