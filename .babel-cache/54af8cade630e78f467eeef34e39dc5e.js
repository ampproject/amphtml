...
export var PullToRefreshBlocker = /*#__PURE__*/function () {
   ...
   */
  function PullToRefreshBlocker(doc, viewport) {_classCallCheck(this, PullToRefreshBlocker);
    /** @private {!Document} */
    this.doc_ = doc;
  ...
  /** */_createClass(PullToRefreshBlocker, [{ key: "cleanup", value:
    function cleanup() {
      this.stopTracking_();
    ...
    function startTracking_(startPos) {
      this.tracking_ = true;
    ...
    /** @private */ }, { key: "stopTracking_", value:
    function stopTracking_() {
      this.tracking_ = false;
      this.startPos_ = 0;
    ...
    function onTouchEnd_(unusedEvent) {
      this.stopTracking_();
    }
    ...
    function onTouchCancel_(unusedEvent) {
      this.stopTracking_();
