...
var EMPTY_CSS_DECLARATION = /** @type {!CSSStyleDeclaration} */({
  'getPropertyPriority': function getPropertyPriority() {return '';},
  'getPropertyValue': function getPropertyValue() {return '';} });
...
export function setStyle(element, property, value, opt_units, opt_bypassCache) {
  var propertyName = getVendorJsPropertyName(
  element.style,
  property,
  opt_bypassCache);
...
export function translate(x, opt_y) {
  ...
  return "translate(".concat(x, ", ").concat(opt_y, ")");
}
