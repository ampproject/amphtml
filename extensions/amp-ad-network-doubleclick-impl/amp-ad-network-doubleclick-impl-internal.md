...
One important **caveat** to keep in mind when using this feature is that no fluid ad slot will fill when it is in the viewport due to AMP's no reflow policy.
