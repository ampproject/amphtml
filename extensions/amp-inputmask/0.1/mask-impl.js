...
export class Mask {
  ...
  constructor(element, mask) {
    ...
    this.element_.addEventListener(AmpEvents_Enum.FORM_VALUE_CHANGE, () => {
      this.mask();
    });
  }
...
/**
 * Convert the AMP mask-string format into an array of Inputmask mask strings.
 *
 * The Inputmask library expects a "*" for an Alphanumeric character,
 * but the AMP mask format requires an "A". This function changes the format
 * AMP document authors provide into the mask format Inputmask expects.
 *
 * e.g. mask="L0L_0L0 00000-0000" -> ['a9a 9a9', '99999-9999']
 *
 * @param {string} ampMask A space-separated list of masks.
 * @return {!Array<string>}
 */
...
/**
 * From XRegExp
 * https://github.com/slevithan/xregexp/blob/7a1688742e20b2745436a5a7793104fc17e3e652/tools/output/categories.js#L40
 */
const NONALPHANUMERIC_REGEXP =
