...
let api = ''; //useQA ? 'https://intakerapiqa.azurewebsites.net' :
// 'https://idemanducoreapi20180624025640.azurewebsites.net';
const cssUrl =
  (useQA ? 'https://intakerclientqa.azurewebsites.net' : 'https://intaker.co') +
  '/dist/chat-widget.min.css';
let directLink = ''; //getDirectLink(url);
const isDesktop = !isMobile();
let cookieName = 'INTAKER_CHAT_WIDGET_';
const cookieValue = {};
const DEFAULT_AVATAR = 'https://intaker.blob.core.windows.net/dashboard/a6.png';
let dingSound = null;
...
function bootstrap(amp) {
  ...
  externalUrl = encodeURI(
    window.DEV_ENV ? 'https://intakerclientqa.azurewebsites.net' : location.host
  );
