...
export const CtaTypes = {
  APPLY_NOW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_APPLY_NOW,
  BOOK_NOW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_BOOK_NOW,
  BUY_TICKETS:
    LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_BUY_TICKETS,
  DOWNLOAD: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_DOWNLOAD,
  EXPLORE: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_EXPLORE,
  GET_NOW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_GET_NOW,
  INSTALL: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_INSTALL,
  LEARN_MORE:
    LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_LEARN_MORE,
  LISTEN: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_LISTEN,
  MORE: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_MORE,
  OPEN_APP: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_OPEN_APP,
  ORDER_NOW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_ORDER_NOW,
  PLAY: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_PLAY,
  READ: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_READ,
  SHOP: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_SHOP,
  SHOW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_SHOW,
  SHOWTIMES: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_SHOWTIMES,
  SIGN_UP: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_SIGN_UP,
  SUBSCRIBE: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_SUBSCRIBE,
  USE_APP: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_USE_APP,
  VIEW: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_VIEW,
  WATCH: LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_WATCH,
  WATCH_EPISODE:
    LOCALIZED_STRING_ID_ENUM.AMP_STORY_AUTO_ADS_BUTTON_LABEL_WATCH_EPISODE,
};
...
export class StoryAdLocalization {
  ...
  /**
   * @param {!../../../src/service/localization/strings.LOCALIZED_STRING_ID_ENUM} id
   * @return {?string}
   */
