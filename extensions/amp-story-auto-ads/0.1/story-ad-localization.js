...
import LocalizedStringsAr from './_locales/ar.json' assert {type: 'json'};
import LocalizedStringsDe from './_locales/de.json' assert {type: 'json'};
import LocalizedStringsEn from './_locales/en.json' assert {type: 'json'};
import LocalizedStringsEnGb from './_locales/en-GB.json' assert {type: 'json'};
import LocalizedStringsEs from './_locales/es.json' assert {type: 'json'};
import LocalizedStringsEs419 from './_locales/es-419.json' assert {type: 'json'};
import LocalizedStringsFr from './_locales/fr.json' assert {type: 'json'};
import LocalizedStringsHi from './_locales/hi.json' assert {type: 'json'};
import LocalizedStringsId from './_locales/id.json' assert {type: 'json'};
import LocalizedStringsIt from './_locales/it.json' assert {type: 'json'};
import LocalizedStringsJa from './_locales/ja.json' assert {type: 'json'};
import LocalizedStringsKo from './_locales/ko.json' assert {type: 'json'};
import LocalizedStringsNl from './_locales/nl.json' assert {type: 'json'};
import LocalizedStringsNo from './_locales/no.json' assert {type: 'json'};
import LocalizedStringsPtBr from './_locales/pt-BR.json' assert {type: 'json'};
import LocalizedStringsPtPt from './_locales/pt-PT.json' assert {type: 'json'};
import LocalizedStringsRu from './_locales/ru.json' assert {type: 'json'};
import LocalizedStringsTr from './_locales/tr.json' assert {type: 'json'};
import LocalizedStringsVi from './_locales/vi.json' assert {type: 'json'};
import LocalizedStringsZhCn from './_locales/zh-CN.json' assert {type: 'json'};
import LocalizedStringsZhTw from './_locales/zh-TW.json' assert {type: 'json'};
