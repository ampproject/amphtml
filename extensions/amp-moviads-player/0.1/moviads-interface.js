...
export let MIN_VISIBILITY_RATIO_FOR_AUTOPLAY = 0.5;
 ...
 * @interface
 */
export class MoviadsPlayerInterface {
  /**
...
/** @param {float} min */
export function changeMinVisibilityRatioForAutoplay(min) {
  MIN_VISIBILITY_RATIO_FOR_AUTOPLAY = min;
}
