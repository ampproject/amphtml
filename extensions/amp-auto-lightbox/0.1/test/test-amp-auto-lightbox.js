  ...
  (env) => {
    ...
    function mockLoadedSignal(element, isLoadedSuccessfully) {
      ...
      if (isLoadedSuccessfully) {
        ...
        signals.rejectSignal(COMMON_SIGNALS_ENUM.LOAD_END, 'Mocked rejection');
      }
      return element;
    }
    ...
    describe('runCandidates', () => {
      it('ignores amp-img load signal after being unlaid out', async () => {
        ...
        signals.reset(COMMON_SIGNALS_ENUM.LOAD_END);
    ...
    describe('apply', () => {
      ...
      it('dispatches event', async () => {
        ...
        element.addEventListener(AUTO_LIGHTBOX_EVENTS_ENUM.NEWLY_SET, eventSpy);
