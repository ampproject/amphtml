...
export const ANALYTICS_CONFIG = {
  ...
  'default': {
    ...
    'vars': {
      ...
      'domExtImgCount': 'DOM_EXT_IMG_COUNT',
      'domExtScriptCount': 'DOM_EXT_SCRIPT_COUNT',
      'domImgCount': 'DOM_IMG_COUNT',
      'domInteractiveTime': 'DOM_INTERACTIVE_TIME',
      'domNodeCount': 'DOM_NODE_COUNT',
      'domScriptCount': 'DOM_SCRIPT_COUNT',
      'navRedirectCount': 'NAV_REDIRECT_COUNT',
      'navTiming': 'NAV_TIMING',
      'navType': 'NAV_TYPE',
      'pageDocLength': 'PAGE_DOC_LENGTH',
      'pageDomainCount': 'PAGE_DOMAIN_COUNT',
