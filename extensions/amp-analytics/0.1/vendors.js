...
export const ANALYTICS_CONFIG = {
  ...
  'webtrekk': {
    'requests': {
      ...
      'pageParameter': '&cp1=${pageParameter1}&cp2=${pageParameter2}' +
          '&cp3=${pageParameter3}&cp4=${pageParameter4}&cp5=${pageParameter5}' +
          '&cp6=${pageParameter6}&cp7=${pageParameter7}&cp8=${pageParameter8}' +
          '&cp9=${pageParameter9}&cp10=${pageParameter10}',
      'pageCategories': '&cg1=${pageCategory1}&cg2=${pageCategory2}' +
          '&cg3=${pageCategory3}&cg4=${pageCategory4}&cg5=${pageCategory5}' +
          '&cg6=${pageCategory6}&cg7=${pageCategory7}&cg8=${pageCategory8}' +
          '&cg9=${pageCategory9}&cg10=${pageCategory10}',
      'pageview': '${trackURL}${parameterPrefix}${pageParameter}${pageCategories}${parameterSuffix}',
      'actionParameter': '&ck1=${actionParameter1}&ck2=${actionParameter2}' +
          '&ck3=${actionParameter3}&ck4=${actionParameter4}&ck5=${actionParameter5}',
