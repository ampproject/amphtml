import {RELATIVE_POSITIONS_ENUM, layoutRectLtwh} from '#core/dom/layout/rect';
...
describes.sandboxed('amp-position-observer', {}, (env) => {
  ...
  function setPosition(top) {
    ...
    let relativePos = RELATIVE_POSITIONS_ENUM.INSIDE;

    if (top > 1000 + 200) {
      positionRect = null;
      relativePos = RELATIVE_POSITIONS_ENUM.BOTTOM;
    } else if (top < -200) {
      positionRect = null;
