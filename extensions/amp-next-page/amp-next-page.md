...
Tracking page views is supported through [`<amp-pixel>`](../../builtins/amp-pixel.md) or `<amp-analytics>` on the host page. It is recommended to use the `ignoreResize` feature of `<amp-analytics>` to get accurate measurements of the scroll triggers
[/tip]
