...
import {SubscriptionPlatform as SubscriptionPlatformDef} from './subscription-platform';
...
export class SubscriptionService {
  ...
  getPageConfig() {
    ...
    return /** @type {!PageConfigDef} */ (pageConfig);
  }
   ...
   *
   * @param {string} serviceId
   * @param {function(!JsonObject, !ServiceAdapter):!SubscriptionPlatformDef} subscriptionPlatformFactory
   * @return {!Promise}
   */
   ...
   * @param {!SubscriptionPlatformDef} platform
  ...
  /**
   * @param {!SubscriptionPlatformDef} subscriptionPlatform
   * @return {!Promise}
   */
