...
<table>
  <tr>
    ...
    <td>The URL of the intermediate iframe. You can use <a href="https://github.com/ampproject/amphtml/blob/main/spec/amp-var-substitutions.md">URL substitution variables</a> to pass values like `ACCESS_READER_ID`.</td>
  </tr>
  <tr>
