import {KEYS_ENUM, KEY_CODES_ENUM} from '#core/constants/key-codes';
        ...
        it('forwards non-ESC events', () => {
          env.win.dispatchEvent(
            new KeyboardEvent(eventType, {
              ...
              keyCode: KEY_CODES_ENUM.LEFT_ARROW,
            })
          );
      ...
      it('forwards multiple events', () => {
        ...
        env.win.document.body.dispatchEvent(
          new KeyboardEvent(eventType, {
            ...
            keyCode: KEY_CODES_ENUM.RIGHT_ARROW,
          })
        );
