...
| First contentful paint (since visible)   | `fcp-v`                      | First paint with content, offset by first visible time                                                                                                                                             |
...
| First input delay (since visible)        | `fid-v`                      | ms delay in handling first input, offset by first visible                                                                                                                                          |
...
| Largest Contentful Paint (since visible) | `lcpl-v`                     | The time in ms for largest contentful element to display, offset by first visible time                                                                                                             |
