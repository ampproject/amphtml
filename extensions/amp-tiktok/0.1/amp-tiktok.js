...
export class AmpTiktok extends AMP.BaseElement {
  ...
  static createLoaderLogoCallback(element) {
    ...
    if (this.oembedResponsePromise_) {
      return {
        color: '#000000',
        content: html` <svg
          width="44"
