...
Accessibility information related to `amp-render`.
...
See [amp-render rules](https://github.com/ampproject/amphtml/blob/master/extensions/amp-render/validator-amp-render.protoascii) in the AMP validator specification.
