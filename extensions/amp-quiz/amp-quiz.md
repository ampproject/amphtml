...
<table>
  ...
  <tr>
    ...
    <td><code>&lt;script async custom-element="amp-quiz" src="https://cdn.ampproject.org/v0/amp-quiz-0.1.js">&lt;/script></code></td>
  </tr>
  <tr>
...
## Validation
See [amp-quiz rules](https://github.com/ampproject/amphtml/blob/master/extensions/amp-quiz/validator-amp-quiz.protoascii) in the AMP validator specification.
