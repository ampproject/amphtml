...
import {BaseElement as BentoAccordion} from '#bento/components/accordion/base-element';
    ...
    xdescribe('', () => {
      ...
      async function waitForExpanded(el, expanded) {
        const isExpandedOrNot = () =>
          ...
          el.firstElementChild.getAttribute('aria-expanded') ===
            String(expanded);
       ...
       * @param {Window} win
       */
      function adoptAccordionStyles(win) {
