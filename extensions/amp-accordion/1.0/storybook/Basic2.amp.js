...
export const attributeSplash = () => {
  const disableSessionStates = boolean('disable-session-states', false); //
  const expanded = boolean('expanded (section 1)', false); //
  ...
  return (
    <main>
      <amp-accordion
        ...
        animate={animate}
        disable-session-states={disableSessionStates}
      >
        <section data-amp-bind-expanded="section1" expanded={expanded}>
          <h2>Section 1</h2>
