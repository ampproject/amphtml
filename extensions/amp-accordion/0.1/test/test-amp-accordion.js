...
describes.realWin('amp-accordion', {
  ...
  it('should collapse when collapse action is triggered on a expanded section', () => {
    return getAmpAccordion().then(ampAccordion => {
      const impl = ampAccordion.implementation_;
      const headerElements = doc.querySelectorAll(
          'section > *:first-child');
  ...
  it('should stay collapsed when collapse action is triggered on a collapsed section', () => {
    return getAmpAccordion().then(ampAccordion => {
      const impl = ampAccordion.implementation_;
      const headerElements = doc.querySelectorAll(
          'section > *:first-child');
