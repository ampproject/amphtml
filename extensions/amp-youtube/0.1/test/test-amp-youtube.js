  ...
  function (env) {
    ...
    function runTestsForDatasource(datasource) {
      ...
      it('should forward certain events from youtube to the amp element', async () => {
        ...
        const pEnded = listenOncePromise(yt, VIDEO_EVENTS_ENUM.ENDED);
        const pPause = listenOncePromise(yt, VIDEO_EVENTS_ENUM.PAUSE);
