...
By supplying two URLs that get called before the notification is shown and after
...
If the `data-show-if-href` attribute is not specified, AMP will only check if
