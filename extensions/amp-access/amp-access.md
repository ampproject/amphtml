...
| authorizationTimeout          | &lt;number&gt;          | Timeout (in milliseconds) after which authorization request is considered as failed. Default is 3000 and it is **not** recommended to change it in production environment. |
