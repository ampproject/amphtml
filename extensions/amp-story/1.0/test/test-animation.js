...
import {WebAnimationPlayState_Enum} from '../../../amp-animation/0.1/web-animation-types';
  ...
  describe('AnimationRunner', () => {
    ...
    it('creates WebAnimationRunner with definition', async () => {
      ...
      const webAnimationRunner = {
        getPlayState: () => WebAnimationPlayState_Enum.IDLE,
        onPlayStateChanged: () => {},
      };
    ...
    it('notifies sequence when finished', async () => {
      ...
      onPlayStateChangedCallback(WebAnimationPlayState_Enum.FINISHED);
