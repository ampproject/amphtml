...
export class AmpStoryVariableService {
  ...
  constructor(win) {
    ...
    this.variables_ = {
      ...
      [AnalyticsVariable.STORY_SHOPPING_CONVERSION_URL]: null,
      [AnalyticsVariable.STORY_SHOPPING_TAG_CLICKED]: null,
      [AnalyticsVariable.STORY_SHOPPING_CTA_CLICKED]: null,
    };
