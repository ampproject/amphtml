...
export const AnalyticsVariable = {
  ...
  STORY_INTERACTION_ID: 'storyInteractionId',
  STORY_INTERACTION_RESPONSE: 'storyInteractionResponse',
...
export class AmpStoryVariableService {
  ...
  constructor(win) {
    ...
    this.variables_ = dict({
      ...
      [AnalyticsVariable.STORY_INTERACTION_ID]: null,
      [AnalyticsVariable.STORY_INTERACTION_RESPONSE]: null,
      [AnalyticsVariable.STORY_INTERACTION_TYPE]: null,
