...
export class AmpStoryVariableService {
  ...
  constructor(win) {
    ...
    this.variables_ = dict({
      ...
      [AnalyticsVariable.STORY_REACTION_ELEMENT_ID]: null,
      [AnalyticsVariable.STORY_REACTION_ELEMENT_RESPONSE]: null,
      [AnalyticsVariable.STORY_REACTION_ELEMENT_TYPE]: null,
