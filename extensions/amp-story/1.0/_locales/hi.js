...
/**
 * Localized string bundle used for hi strings.
...
export default /** @const {!LocalizedStringBundleDef} */ ({
  ...
  [LocalizedStringId.AMP_STORY_TOOLTIP_EXPAND_TWEET]: {
    string: 'ट्वीट को बड़ा करके देखें',
  },
  ...
  [LocalizedStringId.AMP_STORY_WARNING_UNSUPPORTED_BROWSER_TEXT]: {
    string: 'माफ़ करें, लगता है कि आपका ब्राउज़र इस वर्शन पर काम नहीं करता',
  },
  ...
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string: 'यह वर्शन देखने के लिए अपनी विंडो की लंबाई और चौड़ाई, दोनों को बढ़ाएं',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_FAILURE_TEXT]: {
    string: 'लिंक क्लिपबोर्ड पर कॉपी नहीं किया जा सका :(',
  },
  ...
  [LocalizedStringId.AMP_STORY_AUTO_ADS_BUTTON_LABEL_USE_APP]: {
    string: 'ऐप्लिकेशन इस्तेमाल करें',
  },
  ...
  [LocalizedStringId.AMP_STORY_AUTO_ADS_BUTTON_LABEL_INSTALL]: {
    string: 'अभी इंस्टॉल करें',
  },
  [LocalizedStringId.AMP_STORY_WARNING_EXPERIMENT_DISABLED_TEXT]: {
    string: 'यह सामग्री देखने के लिए आपको एएमपी-कहानी की परफ़ॉर्मेंस जाँच चालू करनी होगी.',
  },
