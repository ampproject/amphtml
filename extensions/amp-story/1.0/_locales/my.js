...
export default /** @const {!LocalizedStringBundleDef} */ ({
  ...
  [LocalizedStringId.AMP_STORY_TOOLTIP_EXPAND_TWEET]: {
    string: 'တွိကို ချဲ့ပြရန်',
  },
  [LocalizedStringId.AMP_STORY_DOMAIN_DIALOG_HEADING_LABEL]: {
    string: 'မူရင်းဒိုမိန်းတွင် ကြည့်ခြင်း-',
  },
  ...
  [LocalizedStringId.AMP_STORY_CONTINUE_ANYWAY_BUTTON_LABEL]: {
    string: 'မည်သို့ပင်ဖြစ်စေ ရှေ့ဆက်ရန်',
  },
  ...
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_SUCCESS_TEXT]: {
    string: 'လင့်ခ်ကို မိတ္တူကူးပြီးပါပြီ။',
  },
  ...
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string: 'ဤဇာတ်လမ်းများကိုကြည့်ရန် သင့်ဝင်းဒိုး၏ အမြင့်နှင့်အကျယ် နှစ်ခုစလုံးကို ချဲ့ပါ',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_FAILURE_TEXT]: {
    string: 'ကလစ်ဘုတ်သို့ လင့်ခ်ကို မိတ္တူကူး၍ မရပါ :(',
  },
  [LocalizedStringId.AMP_STORY_AUDIO_MUTE_BUTTON_TEXT]: {
    string: 'အသံပိတ်ထားသည်',
  },
  [LocalizedStringId.AMP_STORY_WARNING_LANDSCAPE_ORIENTATION_TEXT]: {
    string: 'ဤစာမျက်နှာကို ထောင်လိုက်အနေအထားတွင် ကြည့်လျှင် အကောင်းဆုံးဖြစ်ပါသည်',
  },
  ...
  [LocalizedStringId.AMP_STORY_AUDIO_UNMUTE_NO_SOUND_TEXT]: {
    string: 'ဤစာမျက်နှာတွင် အသံမပါရှိပါ',
  },
