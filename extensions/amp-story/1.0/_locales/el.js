...
const strings = {
  ...
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_HEIGHT_SIZE_TEXT]: {
    string:
      'Αναπτύξτε το ύψος του παραθύρου για την προβολή αυτής της ' +
      'εμπειρίας',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string:
      'Αναπτύξτε τόσο το ύψος όσο και το πλάτος του παραθύρου σας για ' +
      'την προβολή αυτής της εμπειρίας',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_WIDTH_SIZE_TEXT]: {
    string:
      'Αναπτύξτε το πλάτος του παραθύρου σας για την προβολή αυτής της ' +
      'εμπειρίας',
  },
  [LocalizedStringId.AMP_STORY_WARNING_EXPERIMENT_DISABLED_TEXT]: {
    string:
      'Πρέπει να ενεργοποιήσετε το πείραμα ιστορίας AMP για να ' +
      'προβάλετε αυτό το περιεχόμενο.',
  },
  [LocalizedStringId.AMP_STORY_WARNING_LANDSCAPE_ORIENTATION_TEXT]: {
    string:
      'Για βέλτιστη προβολή της σελίδας, επιλέξτε κατακόρυφο ' +
      'προσανατολισμό',
  },
  [LocalizedStringId.AMP_STORY_WARNING_UNSUPPORTED_BROWSER_TEXT]: {
    string:
      "Δυστυχώς, απ' ό,τι φαίνεται, το πρόγραμμα περιήγησής σας δεν " +
