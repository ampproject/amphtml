...
export default /** @const {!LocalizedStringBundleDef} */ ({
  ...
  [LocalizedStringId.AMP_STORY_WARNING_UNSUPPORTED_BROWSER_TEXT]: {
    string: 'Samahani, inaonekana kivinjari chako hakitumii hali hii',
  },
  [LocalizedStringId.AMP_STORY_HINT_UI_NEXT_LABEL]: {
    string: 'Gusa Inayofuata',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_SUCCESS_TEXT]: {
    string: 'Kiungo kimenakiliwa!',
  },
  ...
  [LocalizedStringId.AMP_STORY_BOOKEND_PRIVACY_SETTINGS_BUTTON_LABEL]: {
    string: 'Badilisha mipangilio ya faragha ya data',
  },
  ...
  [LocalizedStringId.AMP_STORY_BOOKEND_MORE_TO_READ_LABEL]: {
    string: 'Mapendekezo zaidi ya kusoma',
  },
  ...
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string: 'Panua urefu na upana wa kidirisha chako ili uone hali hii',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_FAILURE_TEXT]: {
    string: 'Imeshindwa kunakili kiungo kwenye ubao wa kunakili :(',
  },
  [LocalizedStringId.AMP_STORY_AUDIO_MUTE_BUTTON_TEXT]: {
    string: 'Sauti imezimwa',
  },
  ...
  [LocalizedStringId.AMP_STORY_DOMAIN_DIALOG_HEADING_LINK]: {
    string: 'Maelezo zadi kuhusu matokeo ya AMP',
  },
