...
/**
 * Localized string bundle used for de strings.
 * @const {!LocalizedStringBundleDef}
 */
export default /** @const {!LocalizedStringBundleDef} */ ({
  [LocalizedStringId.AMP_STORY_HINT_UI_PREVIOUS_LABEL]: {
    string: 'Auf "Zurück" tippen',
  },
  ...
  [LocalizedStringId.AMP_STORY_DOMAIN_DIALOG_HEADING_LABEL]: {
    string: 'In ursprünglicher Domain ansehen:',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_HEIGHT_SIZE_TEXT]: {
    string: 'Maximiere die Höhe deines Fensters, um diese Funktion nutzen zu können',
  },
  ...
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string: 'Maximiere die Höhe und Breite deines Fensters, um diese Funktion nutzen zu können',
  },
  [LocalizedStringId.AMP_STORY_SHARING_CLIPBOARD_FAILURE_TEXT]: {
    string: 'Der Link konnte nicht in die Zwischenablage kopiert werden',
  },
  ...
  [LocalizedStringId.AMP_STORY_DOMAIN_DIALOG_HEADING_LINK]: {
    string: 'Weitere Informationen zu AMP-Ergebnissen',
  },
