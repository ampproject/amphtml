...
export default /** @const {!LocalizedStringBundleDef} */ ({
  ...
  [LocalizedStringId.AMP_STORY_TOOLTIP_EXPAND_TWEET]: {
    string: 'Despregar chío',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_HEIGHT_SIZE_TEXT]: {
    string: 'Amplía a altura da ventá para ver esta experiencia',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_SIZE_TEXT]: {
    string: 'Amplía a altura e a largura da ventá para ver esta experiencia',
  },
  [LocalizedStringId.AMP_STORY_WARNING_DESKTOP_WIDTH_SIZE_TEXT]: {
    string: 'Amplía a largura da ventá para ver esta experiencia',
  },
  [LocalizedStringId.AMP_STORY_WARNING_EXPERIMENT_DISABLED_TEXT]: {
    string: 'Debes activar o experimento da historia AMP para ver este ' +
        'contido.',
  },
