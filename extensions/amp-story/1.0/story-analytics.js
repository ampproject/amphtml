...
/** @enum {string} */
export const StoryAnalyticsEvent_Enum = {
 ...
 */
export const AdvancementMode_Enum = {
  ...
  initializeListeners_() {
    this.storeService_.subscribe(
      ...
      (pageId) => {
        ...
        this.triggerEvent(StoryAnalyticsEvent_Enum.PAGE_VISIBLE);
        ...
        if (pageIndex === pageIds.length - 1) {
          this.triggerEvent(StoryAnalyticsEvent_Enum.LAST_PAGE_VISIBLE);
        }
      },
