...
describes.fakeWin(
    ...
    env => {
      ...
      describe('sendImpressionTracking', () => {
        ...
        describe('amp-analytics setup', () => {
          it('Should generate a page impression id', () => {
            ...
            const impressionId1 = trackingService1.trackingInfo_
                .pageImpressionId;
            ...
            const impressionId2 = trackingService2.trackingInfo_
                .pageImpressionId;
      ...
      describe('sendNaClickTracking', () => {
        ...
        it('Should prioritise xcust set on the link over global xcust with ' +
        'the NA tracking', () => {
          const trackingService = setupTrackingService({
            customTrackingId: 'xcust-id',
          });
