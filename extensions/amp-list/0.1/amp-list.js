...
export class AmpList extends AMP.BaseElement {
  ...
  loadMoreCallback_() {
    ...
    // Reset the 100% - length of load-more inline styles applied to the
    // amp-list container after we load-more since they are only needed
