...
Description of the variables can be found in the [analytics-vars.md](https://github.com/ampproject/amphtml/blob/master/extensions/amp-analytics/analytics-vars.md#fromslide) file.
