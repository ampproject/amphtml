...
export class FontLoader {
  ...
  load(fontConfig, timeout) {
    return new Promise((resolve, reject) => {
      timer.timeoutPromise(timeout, this.load_(fontConfig)).then(() => {
        resolve();
  ...
  compareMeasurements_() {
    return this.defaultFontElements_.some(defaultElement => {
      const hasWidthChanged = (
          Math.abs(
              defaultElement./*REVIEW*/offsetWidth -
              this.customFontElement_./*REVIEW*/offsetWidth) >
              TOLERANCE_);
      const hasHeightChanged = (
          Math.abs(
              defaultElement./*REVIEW*/offsetHeight -
              this.customFontElement_./*REVIEW*/offsetHeight) >
              TOLERANCE_);
