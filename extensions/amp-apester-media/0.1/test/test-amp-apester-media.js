...
import {createIframePromise, doNotLoadExternalResourcesInTest} from "../../../../testing/iframe";
...
describe('amp-apester-media', () => {
    ...
    function testIframe(iframe) {
        ...
        expect(iframe.src).to.equal('http://renderer.qmerce.local.com/interaction/578b4d6d2d9fb72943ce465c');
