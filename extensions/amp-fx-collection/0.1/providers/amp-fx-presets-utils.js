...
export function installStyles(element, fxType) {
  switch (fxType) {
    case FxType_Enum.PARALLAX:
      return {
        'will-change': 'transform',
      };
    case FxType_Enum.FADE_IN:
      return {
        'will-change': 'opacity',
        'opacity': 0,
      };
    case FxType_Enum.FADE_IN_SCROLL:
      return {
        'will-change': 'opacity',
        'opacity': 0,
      };
    case FxType_Enum.FLY_IN_BOTTOM:
    case FxType_Enum.FLY_IN_TOP:
    case FxType_Enum.FLY_IN_LEFT:
    case FxType_Enum.FLY_IN_RIGHT:
      return {
        'will-change': 'transform',
      };
    default:
