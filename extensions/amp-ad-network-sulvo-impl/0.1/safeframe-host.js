...
/**
 * Sets up the host API for Sulvo Safeframe to allow the following
...
export class SafeframeHostApi {
  /**
   * @param {!./amp-ad-network-sulvo-impl.AmpAdNetworkSulvoImpl} baseInstance
   * @param {boolean} isFluid
   * @param {{width:number, height:number}} creativeSize
   */
  constructor(baseInstance, isFluid, creativeSize) {
    /** @private {!./amp-ad-network-sulvo-impl.AmpAdNetworkSulvoImpl} */
