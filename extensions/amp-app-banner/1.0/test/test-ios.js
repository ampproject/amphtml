  ...
  describe("getIOSAppInfo", () => {
    ...
    describe("when meta header is present", () => {
      beforeEach(() => {
        ...
        meta.setAttribute('content', 'app-id=11111111,app-argument=https://test.com/deep-link');
      ...
      it("should parse the meta header and determine appropriate urls", () => {
        ...
        expect(iosInfo.installAppUrl).to.equal('https://itunes.apple.com/us/app/id11111111');
