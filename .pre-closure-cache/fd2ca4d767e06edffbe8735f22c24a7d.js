import { resolvedPromise as _resolvedPromise3 } from "./../../core/data-structures/promise";import { resolvedPromise as _resolvedPromise2 } from "./../../core/data-structures/promise";import { resolvedPromise as _resolvedPromise } from "./../../core/data-structures/promise"; /**
...
export class ViewportImpl {
  ...
  /** @override */
  animateScrollIntoView(element, pos = 'top', opt_duration, opt_curve) {let _pos = pos;
    if (false) {
      return new Promise((resolve, opt_) => {
        element. /* OK */scrollIntoView({
          block: SCROLL_POS_TO_BLOCK[_pos],
          behavior: 'smooth' });
 ...
 * @return {number}
 */
function getDefaultScrollAnimationDuration(scrollTopA, scrollTopB, max = 500) {let _max = max;
  // 65% of scroll Δ to ms, eg 1000px -> 650ms, integer between 0 and max
  return Math.floor(clamp(0.65 * Math.abs(scrollTopA - scrollTopB), 0, _max));
}
