...
export class GlobalVariableSource extends VariableSource {
  ...
  initialize() {
    ...
    this.setBoth(
    'QUERY_PARAM',
    (param, defaultValue = '') => {let _defaultValue = defaultValue;
      return this.getQueryParamData_(param, _defaultValue);
    },
    (param, defaultValue = '') => {let _defaultValue2 = defaultValue;
      return getTrackImpressionPromise().then(() => {
        return this.getQueryParamData_(param, _defaultValue2);
      });
    });
    ...
    this.set('FRAGMENT_PARAM', (param, defaultValue = '') => {let _defaultValue3 = defaultValue;
      return this.getFragmentParamData_(param, _defaultValue3);
    });
