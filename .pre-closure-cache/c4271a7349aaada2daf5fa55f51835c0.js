import { resolvedPromise as _resolvedPromise } from "./../../../src/core/data-structures/promise";const _template = ["<div class=i-amphtml-story-draggable-drawer><div class=i-amphtml-story-draggable-drawer-container><div class=i-amphtml-story-draggable-drawer-content></div></div></div>"],_template2 = ["<div class=i-amphtml-story-draggable-drawer-header></div>"]; /**
...
export class DraggableDrawer extends AMP.BaseElement {
  ...
  onSwipeY_(gesture) {
    ...
    if (this.state === DrawerState.OPEN) {
      const isContentSwipe = this.isDrawerContentDescendant_( /** @type {!Element} */(
