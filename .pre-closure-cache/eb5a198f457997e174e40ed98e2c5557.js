...
export class AccessSource {
  ...
  buildConfigType_(configJson) {
    ...
    userAssert(
    !type || type === "client" || type === "iframe" || type === "server" || type === "vendor" || type === "other",
   ...
   * @return {!Promise}
   */
  loginWithUrl(url, eventLabel = '') {let _eventLabel = eventLabel;
    return this.login_(url, _eventLabel);
  }
