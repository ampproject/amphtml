...
parseSchemaImage,
setMediaSession,
validateMediaMetadata } from "../../../src/mediasession-helper";

import { Layout, applyFillContent, isLayoutSizeFixed } from "../../../src/core/dom/layout";
import { assertHttpsUrl } from "../../../src/url";
import {
closestAncestorElementBySelector,
realChildNodes } from "../../../src/core/dom/query";
  ...
  buildAudioElement() {
    ...
    realChildNodes(this.element).forEach((child) => {
      if (child.getAttribute && child.getAttribute('src')) {
        assertHttpsUrl(child.getAttribute('src'), /** @type {!Element} */(child));
      }
