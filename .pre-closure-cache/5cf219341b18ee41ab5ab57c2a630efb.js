...
CONSENT_STRING_TYPE } from "../../../src/core/constants/consent-state";
...
maybeInsertOriginTrialToken } from "../../../ads/google/a4a/utils";
...
isInManualExperiment } from "../../../ads/google/a4a/traffic-experiments";
...
import {
getExperimentBranch,
randomlySelectUnsetExperiments } from "../../../src/experiments";
...
export class AmpAdNetworkAdsenseImpl extends AmpA4A {
  ...
  */
  ...
  onCreativeRender(creativeMetaData) {
    ...
    setStyles( /** @type {!Element} */(this.iframe), {
    ...
    /** @type {!Element} */(this.iframe).id = `google_ads_iframe_${this.ifi_}`;
  }
