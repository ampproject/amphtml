...
export class ActionInvocation {
  ...
  {let _actionEventType = actionEventType,_tagOrTarget = tagOrTarget,_sequenceId = sequenceId;
    /** @type {!Node} */
    this.node = node;
    /** @const {string} */
    this.method = method;
    ...
    this.trust = trust;
    /** @const {?string} */
    this.actionEventType = _actionEventType;
    /** @const {string} */
    this.tagOrTarget = _tagOrTarget || node.tagName;
    /** @const {number} */
...
export class ActionService {
   ...
   */
  addGlobalMethodHandler(name, handler, minTrust = ActionTrust.DEFAULT) {let _minTrust = minTrust;
    this.globalMethodHandlers_[name] = { handler, minTrust: _minTrust };
  }
  ...
  invoke_(invocation) {
    ...
    const node = /** @type {!Element} */(invocation.node);
