...
export class BaseElement {
   ...
   * @public
   */
  registerAction(alias, handler, minTrust = ActionTrust.DEFAULT) {let _minTrust = minTrust;
    initActionMap(this);
    this['actionMap_'][alias] = { handler, minTrust: _minTrust };
  }
  ...
  {let _alias = alias,_minTrust2 = minTrust;
    devAssert(
    !this['defaultActionAlias_']);



    this.registerAction(_alias, handler, _minTrust2);
    this['defaultActionAlias_'] = _alias;
  }
  ...
  toggleLoading(state, force = false) {let _force = force;
    this.element.toggleLoading(state, _force);
  }
