...
export class Gestures {
  ...
  {let _opt_shouldNotPreventDefault = opt_shouldNotPreventDefault,_opt_shouldStopPropagation = opt_shouldStopPropagation;
    let res = element[PROP_];
    if (!res) {
      res = new Gestures(
      element,
      _opt_shouldNotPreventDefault,
      _opt_shouldStopPropagation);
