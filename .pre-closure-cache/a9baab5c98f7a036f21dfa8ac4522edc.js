import { resolvedPromise as _resolvedPromise } from "./../../../src/core/data-structures/promise";const _template = ["<div class=i-amphtml-carousel-content><div class=i-amphtml-carousel-scroll tabindex=-1></div><div class=i-amphtml-base-carousel-arrows><div class=i-amphtml-base-carousel-arrow-prev-slot></div><div class=i-amphtml-base-carousel-arrow-next-slot></div></div></div>"],_template2 = ["<button class=i-amphtml-base-carousel-arrow aria-label=\"Next item in carousel\"><div class=i-amphtml-base-carousel-arrow-frosting></div><div class=i-amphtml-base-carousel-arrow-backdrop></div><div class=i-amphtml-base-carousel-arrow-background></div><svg class=i-amphtml-base-carousel-arrow-icon viewBox=\"0 0 24 24\"><path d=\"M10,7.4 L14.6,12 L10,16.6\" fill=none stroke-width=2px stroke-linejoin=round stroke-linecap=round></path></svg></button>"],_template3 = ["<button class=i-amphtml-base-carousel-arrow aria-label=\"Previous item in carousel\"><div class=i-amphtml-base-carousel-arrow-frosting></div><div class=i-amphtml-base-carousel-arrow-backdrop></div><div class=i-amphtml-base-carousel-arrow-background></div><svg class=i-amphtml-base-carousel-arrow-icon viewBox=\"0 0 24 24\"><path d=\"M14,7.4 L9.4,12 L14,16.6\" fill=none stroke-width=2px stroke-linejoin=round stroke-linecap=round></path></svg></button>"]; /**
...
getResponsiveAttributeValue } from "./responsive-attributes";
...
class AmpCarousel extends AMP.BaseElement {
  ...
  buildCallback() {
    ...
    this.carousel_ = new Carousel({
      ...
      scrollContainer: /** @type {!Element} */(this.scrollContainer_),
   ...
   * }=} options
   */
  goToSlide(index, options = {}) {let _options = options;
    const { actionSource, smoothScroll = false } = _options;
  ...
  initializeChildLayoutManagement_() {
    ...
    this.childLayoutManager_ = new ChildLayoutManager({
      ampElement: this,
      intersectionElement: /** @type {!Element} */(this.scrollContainer_),
