...
export class AmpDoc {
  ...
  constructor(win, parent, opt_options) {
    ...
    paramsVisibilityState === "prerender" || paramsVisibilityState === "visible" || paramsVisibilityState === "hidden" || paramsVisibilityState === "paused" || paramsVisibilityState === "inactive");
