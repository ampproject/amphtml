const _template = ["<div class=\"i-amphtml-story-expanded-view-overflow i-amphtml-story-system-reset\"><button class=i-amphtml-expanded-view-close-button aria-label=close role=button></button></div>"],_template2 = ["<style></style>"],_template3 = ["<section class=\"i-amphtml-story-focused-state-layer i-amphtml-story-system-reset i-amphtml-hidden\"><div class=\"i-amphtml-story-focused-state-layer-nav-button-container i-amphtml-story-tooltip-nav-button-left\"><button ref=buttonLeft class=\"i-amphtml-story-focused-state-layer-nav-button i-amphtml-story-tooltip-nav-button-left\"></button></div><div class=\"i-amphtml-story-focused-state-layer-nav-button-container i-amphtml-story-tooltip-nav-button-right\"><button ref=buttonRight class=\"i-amphtml-story-focused-state-layer-nav-button i-amphtml-story-tooltip-nav-button-right\"></button></div><a class=i-amphtml-story-tooltip target=_blank ref=tooltip role=tooltip><div class=i-amphtml-story-tooltip-custom-icon></div><p class=i-amphtml-tooltip-text ref=text></p><div class=i-amphtml-tooltip-action-icon></div><div class=i-amphtml-story-tooltip-arrow ref=arrow></div></a></section>"]; /**
 ...
 * @return {!Element}
 */
const buildExpandedViewOverlay = (element) => htmlFor(element)(_template);
...
export class AmpStoryEmbeddedComponent {
  ...
  toggleExpandedView_(targetToExpand) {
    if (!targetToExpand) {
      ...
      this.mutator_.mutateElement(this.expandedViewOverlay_, () => {
        ...
        toggle( /** @type {!Element} */(this.expandedViewOverlay_), false);
    ...
    this.expandedViewOverlay_),
    () => {
      toggle( /** @type {!Element} */(this.expandedViewOverlay_), true);
  ...
  buildAndAppendExpandedViewOverlay_() {
    ...
    const closeButton = /** @type {!Element} */(
    ...
    this.mutator_.mutateElement( /** @type {!Element} */(this.componentPage_), () =>
   ...
   * @private
   */
  maybeCloseExpandedView_(target, forceClose = false) {let _forceClose = forceClose;
    if (
  ...
  closeExpandedEl_() {
    ...
    const embedStyleEl = /** @type {!Element} */(
  ...
  static prepareForAnimation(pageEl, element, mutator) {
    ...
    () => {
      ...
      if (!element.hasAttribute(EMBED_ID_ATTRIBUTE_NAME)) {
        ...
        const embedStyleEl = html(_template2);
  ...
  updateTooltipActionIcon_(embedConfig) {
    ...
    this.mutator_.mutateElement( /** @type {!Element} */(actionIcon), () => {
  ...
  updateTooltipComponentIcon_(target, embedConfig) {
    ...
    this.mutator_.mutateElement( /** @type {!Element} */(tooltipCustomIcon), () => {
  ...
  positionTooltip_(component) {
    ...
    () => {
      ...
      setImportantStyles( /** @type {!Element} */(this.tooltipArrow_), {
  ...
  onOutsideTooltipClick_(event) {
    if (
    !closest( /** @type {!Element} */(event.target), (el) => el == this.tooltip_))
    {
      event.stopPropagation();
      this.close_();
    }
   ...
   */
  clearTooltip_() {
    this.mutator_.mutateElement( /** @type {!Element} */(this.tooltip_), () => {
      const actionIcon = this.tooltip_.querySelector(
      '.i-amphtml-tooltip-action-icon');
  ...
  buildFocusedStateTemplate_(doc) {
    ...
    const tooltipOverlay = html(_template3);
