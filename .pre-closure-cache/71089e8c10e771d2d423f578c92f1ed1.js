...
loadAll,
pauseAll,
unmountAll } from "../core/dom/resource-container-helper";
 ...
 */
export function createSlot(element, name, defaultProps, as = false) {let _as = as;
  element.setAttribute('slot', name);
  if (!_as) {
    return Preact.createElement(Slot, { ...((defaultProps || EMPTY)), name: name });
  }
  ...
  function SlotWithProps(props) {
    return Preact.createElement(Slot, { ...((defaultProps || EMPTY)), name: name, ...props });
  }
...
export function Slot(props) {
  ...
  return Preact.createElement("slot", { ...props, ref: ref });
}
