...
export class ProgressBar {
   ...
   * @private
   */
  render_(shouldAnimate = true) {let _shouldAnimate = shouldAnimate;
   ...
   */
  updateProgress(segmentId, progress, updateAllSegments = false) {let _updateAllSegments = updateAllSegments;
    this.segmentsAddedPromise_.then(() => {
      ...
      // bar segments.
      if (this.activeSegmentIndex_ !== segmentIndex || _updateAllSegments) {
   ...
   * @public
   */
  updateProgressByIndex_(segmentIndex, progress, withTransition = true) {let _withTransition = withTransition;
