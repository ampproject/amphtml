const _template = ["<div class=i-amphtml-story-affiliate-link-circle><i class=i-amphtml-story-affiliate-link-icon></i><div class=\"i-amphtml-story-reset i-amphtml-hidden\"><span class=i-amphtml-story-affiliate-link-text hidden></span> <i class=i-amphtml-story-affiliate-link-launch hidden></i></div></div>"],_template2 = ["<div class=i-amphtml-story-affiliate-link-pulse></div>"]; /**
...
export class AmpStoryAffiliateLink {
   ...
   */
  addIconElement_() {
    const iconEl = htmlFor(this.element_)(_template);
   ...
   */
  addPulseElement_() {
    const pulseEl = htmlFor(this.element_)(_template2);
