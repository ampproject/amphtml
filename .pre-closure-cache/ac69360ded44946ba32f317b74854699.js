const _template = ["<button class=i-amphtml-story-page-attachment-close-button aria-label=close role=button></button>"],_template2 = ["<span class=i-amphtml-story-page-attachment-title></span>"],_template3 = ["<div class=i-amphtml-story-draggable-drawer-header-title-and-close></div>"],_template4 = ["<a class=i-amphtml-story-page-attachment-remote-content target=_blank><span class=i-amphtml-story-page-attachment-remote-title></span> <span class=i-amphtml-story-page-attachment-remote-icon></span></a>"],_template5 = ["<a class=i-amphtml-story-page-attachment-remote-content target=_blank><span class=i-amphtml-story-page-attachment-remote-title><span ref=openStringEl></span><span ref=urlStringEl></span></span> <svg class=i-amphtml-story-page-attachment-remote-icon xmlns=http://www.w3.org/2000/svg viewBox=\"0 0 48 48\"><path d=\"M38 38H10V10h14V6H10c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 4 4 4h28c2.21 0 4-1.79 4-4V24h-4v14zM28 6v4h7.17L15.51 29.66l2.83 2.83L38 12.83V20h4V6H28z\"></path></svg></a>"]; /**
...
export class AmpStoryPageAttachment extends DraggableDrawer {
   ...
   */
  buildInline_() {
    const closeButtonEl = htmlFor(this.element)(_template);



    const localizationService = getLocalizationService(devAssert(this.element));

    const titleEl = htmlFor(this.element)(_template2);
  ...
  buildRemote_() {
    ...
    const link = htmlFor(this.element)(_template4);
  ...
  buildRemoteV2_() {
    ...
    this.element.classList.add('i-amphtml-story-page-attachment-remote');
    // Use an anchor element to make this a real link in vertical rendering.
    const link = htmlFor(this.element)(_template5);
   ...
   * @override
   */
  open(shouldAnimate = true) {let _shouldAnimate = shouldAnimate;
    if (this.state === DrawerState.OPEN) {
      return;
    }

    super.open(_shouldAnimate);
   ...
   * @override
   */
  closeInternal_(shouldAnimate = true) {let _shouldAnimate2 = shouldAnimate;
    if (this.state === DrawerState.CLOSED) {
      return;
    }

    super.closeInternal_(_shouldAnimate2);
