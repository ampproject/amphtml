...
export class DomAncestorVisitor {
  /** @param {!Window=} win */
  constructor(win = window) {let _win = win;
    /**
   ...
   */
  addVisitor(callback, maxAncestorsToVisit = 100) {let _maxAncestorsToVisit = maxAncestorsToVisit;
    this.visitors_.push(new Visitor(callback, _maxAncestorsToVisit));
    return this;
  }
