import { $closeButton as _$closeButton } from "./component.jss";import { $wrapper as _$wrapper } from "./component.jss";import { $content as _$content } from "./component.jss"; /**
...
{let _animation = animation;
  ...
  const animationRef = useValueRef(_animation);
  ...
  Preact.createElement(CloseButton, { as: closeButtonAs, onClick: () => setVisible(false) }),
  children));
 ...
 * @return {PreactDef.Renderable}
 */
function CloseButton({ onClick, as: Comp = ScreenReaderCloseButton }) {let _Comp = Comp;
  return Preact.createElement(_Comp, { "aria-label": DEFAULT_CLOSE_LABEL, onClick: onClick });
}
...
function ScreenReaderCloseButton(props) {
  ...
  return Preact.createElement("button", { ...props, tabIndex: -1, className: _$closeButton });
}