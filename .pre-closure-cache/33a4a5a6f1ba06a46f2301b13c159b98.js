const _template = ["<div slot=i-amphtml-svc class=\"i-amphtml-svc i-amphtml-loading-container i-amphtml-fill-content amp-hidden\"></div>"]; /**
...
export class LoadingIndicatorImpl {
  ...
  createLoaderState_(element, width, height) {
    ...
    const container = htmlFor(this.ampdoc_.win.document)(_template);
