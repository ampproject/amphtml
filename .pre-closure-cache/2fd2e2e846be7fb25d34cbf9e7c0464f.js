const _template = ["<div class=\"i-amphtml-story-share-menu i-amphtml-story-system-reset\" aria-hidden=true role=alert><div class=i-amphtml-story-share-menu-container><button class=i-amphtml-story-share-menu-close-button aria-label=close role=button>&times;</button></div></div>"],_template2 = ["<amp-social-share type=system></amp-social-share>"]; /**
...
export class ShareMenu {
  ...
  buildForSystemSharing_() {
    ...
    this.vsync_.mutate(() => {
      setStyles( /** @type {!Element} */(this.element_), {
        'visibility': 'hidden',
        'pointer-events': 'none',
        'z-index': -1 });
