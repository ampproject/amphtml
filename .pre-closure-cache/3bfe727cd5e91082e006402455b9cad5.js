 ...
 */
export function makeClickDelaySpec(delay, startTimingEvent = undefined) {let _startTimingEvent = startTimingEvent;
  return { type: FilterType.CLICK_DELAY, delay, startTimingEvent: _startTimingEvent };
}