...
recalculateConsentStateValue } from "./consent-info";
...
export class ConsentStateManager {
   ...
   */
  updateConsentInstancePurposes(purposeMap, defaultsOnly = false) {let _defaultsOnly = defaultsOnly;
    ...
    purposes.forEach((purpose) => {
      ...
      if (_defaultsOnly && hasOwn(this.purposeConsents_, purpose)) {
        return;
      }
