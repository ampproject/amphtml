...
export class MediaPool {
  ...
  swapPoolMediaElementOutOfDom_(poolMediaEl) {
    ...
    const placeholderEl = /** @type {!Element} */ /** @type {!PlaceholderElementDef} */(
   ...
   */
  pause(domMediaEl, rewindToBeginning = false) {let _rewindToBeginning = rewindToBeginning;
    const mediaType = this.getMediaType_(domMediaEl);
