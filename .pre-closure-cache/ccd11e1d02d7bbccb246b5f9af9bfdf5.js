import { resolvedPromise as _resolvedPromise2 } from "./../core/data-structures/promise";import { resolvedPromise as _resolvedPromise } from "./../core/data-structures/promise"; /**
...
export class StandardActions {
  ...
  handleNavigateTo_(invocation) {
    ...
    let permission = _resolvedPromise();
  ...
  handleHide_(invocation) {
    const target = /** @type {!Element} */(invocation.node);
  ...
  handleShow_(invocation) {
    const { node } = invocation;
    const target = /** @type {!Element} */(node);
