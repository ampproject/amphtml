...
export class LocalizationService {
   ...
   * @return {?string}
   */
  getLocalizedString(localizedStringId, elementToUse = this.element_) {let _elementToUse = elementToUse;
    const languageCodes = this.getLanguageCodesForElement_(_elementToUse);
