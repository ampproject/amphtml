...
export class SsrTemplateHelper {
   ...
   */
  ssr(element, request, opt_templates = null, opt_attributes = {}) {let _opt_templates = opt_templates,_opt_attributes = opt_attributes;
   ...
   * @private
   */
  buildPayload_(request, mustacheTemplate, opt_templates, opt_attributes = {}) {let _opt_attributes2 = opt_attributes;
    ...
    if (_opt_attributes2) {
      Object.assign(ampComponent, _opt_attributes2);
    }
