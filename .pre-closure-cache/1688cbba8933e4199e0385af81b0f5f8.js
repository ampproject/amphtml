    ...
    for (const k in this.config_['triggers']) {
      if (hasOwn(this.config_['triggers'], k)) {
        ...
        if (this.isSandbox_) {
          ...
          if (
          (eventType === "click" || eventType === "custom" || eventType === "hidden" || eventType === "ini-load" || eventType === "render-start" || eventType === "scroll" || eventType === "story" || eventType === "timer" || eventType === "video" || eventType === "visible") &&
