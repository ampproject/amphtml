...
export class ViewerImpl {
  ...
  setVisibilityState_(state) {
    ...
    devAssert(state === "prerender" || state === "visible" || state === "hidden" || state === "paused" || state === "inactive");
  ...
  /** @override */
  sendMessage(eventType, data, cancelUnsent = false) {let _cancelUnsent = cancelUnsent;
    this.sendMessageInternal_(eventType, data, _cancelUnsent, false);
  }

  /** @override */
  sendMessageAwaitResponse(eventType, data, cancelUnsent = false) {let _cancelUnsent2 = cancelUnsent;
    return this.sendMessageInternal_(eventType, data, _cancelUnsent2, true);
  }
