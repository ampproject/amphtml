...
export class MediaTask {
   ...
   */
  constructor(name, options = {}) {let _options = options;
...
export class SetCurrentTimeTask extends MediaTask {
   ...
   * @param {!Object=} options
   */
  constructor(options = { currentTime: 0 }) {let _options2 = options;
    super('setCurrentTime', _options2);
  }
