 ...
 */
export function getConsentPolicyState(element, policyId = 'default') {let _policyId = policyId;
  return Services.consentPolicyServiceForDocOrNull(element).then(
  (consentPolicy) => {
    if (!consentPolicy) {
      return null;
    }
    return consentPolicy.whenPolicyResolved( /** @type {string} */(_policyId));
  });
 ...
 */
export function getConsentPolicyInfo(element, policyId = 'default') {let _policyId2 = policyId;
 ...
 */
export function getConsentMetadata(element, policyId = 'default') {let _policyId3 = policyId;
