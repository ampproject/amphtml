...
export class AmpStoryAccess extends AMP.BaseElement {
   ...
   * @private
   */
  getActionObject_(namespace = undefined, type = undefined) {let _namespace = namespace,_type = type;
    const method = ['login', _namespace, _type].filter(Boolean).join('-');
