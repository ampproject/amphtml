...
import { propagateObjectFitStyles } from "../../../src/core/dom/style";
...
export class AmpAnim extends AMP.BaseElement {
  ...
  buildCallback() {
    ...
    st.toggle( /** @type {!Element} */(this.img_), !this.getPlaceholder());
  ...
  viewportCallback_(inViewport) {
    ...
    st.toggle( /** @type {!Element} */(this.img_), inViewport);
  }}
