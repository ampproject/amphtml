...
export class Sources {
   ...
   *     media element.
   */
  constructor(srcAttr = null, srcEls = [], trackEls = []) {let _srcAttr = srcAttr,_srcEls = srcEls,_trackEls = trackEls;
    /** @private @const {?string} */
    this.srcAttr_ = _srcAttr;

    /** @private @const {!Array<!Element>} */
    this.srcEls_ = _srcEls;

    /** @private @const {!Array<!Element>} */
    this.trackEls_ = _trackEls;
  }
