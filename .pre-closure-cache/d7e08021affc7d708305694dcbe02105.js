const _template = ["<img placeholder referrerpolicy=origin loading=lazy>"]; /**
...
mutedOrUnmutedEvent,
originMatches,
redispatch } from "../../../src/iframe-video";
...
class AmpBridPlayer extends AMP.BaseElement {
  ...
  createPlaceholderCallback() {
    ...
    const placeholder = html(_template);
  ...
  fullscreenEnter() {
    ...
    fullscreenEnter( /** @type {!Element} */(this.iframe_));
  }
  ...
  fullscreenExit() {
    ...
    fullscreenExit( /** @type {!Element} */(this.iframe_));
  }
  ...
  isFullscreen() {
    ...
    return isFullscreenElement( /** @type {!Element} */(this.iframe_));
  }
