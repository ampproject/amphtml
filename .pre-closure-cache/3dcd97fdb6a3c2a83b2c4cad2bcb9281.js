 ...
 */
export function initRecaptcha(recaptchaApiBaseUrl = RECAPTCHA_API_URL) {let _recaptchaApiBaseUrl = recaptchaApiBaseUrl;
  const win = window;
  ...
  if (dataObject.global) {
    _recaptchaApiBaseUrl = GLOBAL_RECAPTCHA_API_URL;
  }
  const recaptchaApiUrl = _recaptchaApiBaseUrl + sitekey;
