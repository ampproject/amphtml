...
import {
observeContentSize,
unobserveContentSize } from "../../../src/core/dom/layout/size-observer";
...
export class Amp3dGltf extends AMP.BaseElement {
  ...
  listenGltfViewerMessages_() {
    ...
    listenFor( /** @type {!Element} */(this.iframe_), evName, cb, true);
  ...
  postMessage_(type, message) {
    postMessage( /** @type {!Element} */(this.iframe_), type, message, '*', true);
  }
