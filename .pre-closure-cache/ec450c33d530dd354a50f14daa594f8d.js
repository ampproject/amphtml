 ...
 */
export function setCookie(win, name, value, expirationTime, options = {}) {let _options = options;
  checkOriginForSettingCookie(win, _options, name);
  let domain = undefined;
  // Respect explicitly set domain over higestAvailabeDomain
  if (_options.domain) {
    domain = _options.domain;
  } else if (_options.highestAvailableDomain) {
