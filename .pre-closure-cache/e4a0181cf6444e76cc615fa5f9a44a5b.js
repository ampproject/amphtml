var _button, _button2, _button3, _button4, _button5, _button6; /**
...
export const Default = () => {
  ...
  return (
    ...
    Preact.createElement("amp-base-carousel", {
      id: "carousel",
    ...
    Array.from({ length: slideCount }, (x, i) => {
      ...
      return (
        Preact.createElement("amp-layout", { width: "225", height: "225", layout: "responsive" },
    ...
    Preact.createElement("div", { class: "buttons", style: { marginTop: 8 } }, (((_button || (((_button =
    Preact.createElement("button", { on: "tap:carousel.goToSlide(index=3)" }, "goToSlide(index=3)"))))))), (((_button2 || (((_button2 =
    Preact.createElement("button", { on: "tap:carousel.next" }, "Next"))))))), (((_button3 || (((_button3 =
    Preact.createElement("button", { on: "tap:carousel.prev" }, "Prev"))))))), (((_button4 || (((_button4 =
    Preact.createElement("button", { on: "tap:AMP.setState({activeSlide: 3})" }, "mutate slide to index 3"))))))))));
...
export const customArrows = () => {
  ...
  const colorIncrement = Math.floor(255 / (slideCount + 1));
  return (
    Preact.createElement("amp-base-carousel", { id: "my-carousel", width: width, height: height },
    Array.from({ length: slideCount }, (x, i) => {
      const v = colorIncrement * ((i + 1));
      return (
        Preact.createElement("div", {
    ...
    Preact.createElement("button", { slot: "next-arrow" }, "Next"))))), ((_button6 || ((_button6 =
    Preact.createElement("button", { slot: "prev-arrow" }, "Prev")))))));
