const _template = ["<i-amphtml-sizer class=i-amphtml-sizer slot=i-amphtml-svc><img alt=\"\" role=presentation aria-hidden=true class=i-amphtml-intrinsic-sizer></i-amphtml-sizer>"]; /**
 ...
 * @return {!Layout}
 */
export function applyStaticLayout(element, fixIeIntrinsic = false) {let _fixIeIntrinsic = fixIeIntrinsic;
  ...
  if (layout == Layout.NODISPLAY) {
    ...
    const sizer = htmlFor(element)(_template);
    ...
    'src',
    !false && _fixIeIntrinsic && element.ownerDocument ?
    transparentPng(
