import { resolvedPromise as _resolvedPromise2 } from "./../../../src/core/data-structures/promise";import { resolvedPromise as _resolvedPromise } from "./../../../src/core/data-structures/promise";const _template = ["<div class=\"i-amphtml-story-info-dialog i-amphtml-story-system-reset\"><div class=i-amphtml-story-info-dialog-container><h1 class=i-amphtml-story-info-heading></h1><a class=i-amphtml-story-info-link></a> <a class=i-amphtml-story-info-moreinfo></a></div></div>"]; /**
...
export class InfoDialog {
  ...
  onInfoDialogStateUpdated_(isOpen) {
    this.mutator_.mutateElement( /** @type {!Element} */(this.element_), () => {
