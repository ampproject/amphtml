...
AdvanceExpToTime,
StoryAdAutoAdvance,
divertStoryAdAutoAdvance } from "../../../src/experiments/story-ad-auto-advance";

import {
AnalyticsEvents,
AnalyticsVars,
STORY_AD_ANALYTICS,
StoryAdAnalytics } from "./story-ad-analytics";
...
import {
StoryAdSegmentExp,
ViewerSetTimeToBranch } from "../../../src/experiments/story-ad-progress-segment";
...
export class AmpStoryAutoAds extends AMP.BaseElement {
  ...
  initializeListeners_() {
    ...
    this.storeService_.subscribe(StateProperty.CURRENT_PAGE_ID, (pageId) => {
      ...
      this.handleActivePageChange_( /** @type {number} */(
