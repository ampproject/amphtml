import { resolvedPromise as _resolvedPromise3 } from "./../../../src/core/data-structures/promise";import { resolvedPromise as _resolvedPromise2 } from "./../../../src/core/data-structures/promise";import { resolvedPromise as _resolvedPromise } from "./../../../src/core/data-structures/promise"; /**
...
function isCustomBrowserTriggerType(triggerType) {
  return triggerType === "blur" || triggerType === "change";
}
...
function isReservedTriggerType(triggerType) {
  return triggerType === "click" || triggerType === "browser-event" || triggerType === "custom" || triggerType === "hidden" || triggerType === "ini-load" || triggerType === "render-start" || triggerType === "scroll" || triggerType === "story" || triggerType === "timer" || triggerType === "video" || triggerType === "visible";
}
...
export class AnalyticsEvent {
   ...
   */
  constructor(target, type, vars = dict(), enableDataVars = true) {let _vars = vars,_enableDataVars = enableDataVars;
    /** @const */
    this['target'] = target;
    /** @const */
    this['type'] = type;
    /** @const */
    this['vars'] = _enableDataVars ? mergeDataVars(target, _vars) : _vars;
  }}
