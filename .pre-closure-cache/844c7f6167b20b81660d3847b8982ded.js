...
import {
copyTextToClipboard,
isCopyingToClipboardSupported } from "../../../src/clipboard";
...
export class ShareWidget {
   ...
   */
  isSystemShareSupported(ampdoc = this.getAmpDoc_()) {let _ampdoc = ampdoc;
    const viewer = Services.viewerForDoc(_ampdoc);
   ...
   * @param {!../../../src/service/ampdoc-impl.AmpDoc=} ampdoc
   */
  loadRequiredExtensions(ampdoc = this.getAmpDoc_()) {let _ampdoc2 = ampdoc;
