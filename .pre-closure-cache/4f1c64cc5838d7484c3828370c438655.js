...
export class Dialog {
  ...
  constructor(ampdoc) {
    ...
    /** @private {!Promise} */
    this.lastAction_ = _resolvedPromise();
   ...
   * @return {!Promise}
   */
  open(content, showCloseAction = true) {let _showCloseAction = showCloseAction;
    return this.action_(() => this.open_(content, _showCloseAction));
  }
   ...
   * @private
   */
  open_(content, showCloseAction = true) {let _showCloseAction2 = showCloseAction;
    if (this.content_) {
    ...
    mutatePromise(() => {
      ...
      this.showCloseAction( /** @type {boolean} */(_showCloseAction2));
    }).
    then(() => {
      // Animate to display.
      return this.vsync_.
