 ...
 */
export function timeStrToMillis(time, fallbackMs = NaN) {let _fallbackMs = fallbackMs;
 ...
 * @return {?string}
 */
export function getStoryAttributeSrc(element, attribute, warn = false) {let _warn = warn;
