...
# AMP Boilerplate Code ('head > style : boilerplate' and 'noscript > style : boilerplate')
...
immediately before it closes; (2) replacing any space with arbitrary whitespace.
