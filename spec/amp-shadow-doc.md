...
- `shadowDoc.close()` - closes the AMP document and frees the resources (partly asynchronous).
- `shadowDoc.closeAsync()` - closes the AMP document, frees the resources, and returns a promise that resolves when cleanup is complete.
