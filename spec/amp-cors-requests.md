...
Read on: For information on AMP Cache URL formats, see these resources: [Google AMP Cache Overview](https://developers.google.com/amp/cache/overview) and [Cloudflare AMP Cache](https://amp.cloudflare.com/).
