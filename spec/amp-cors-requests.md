...
When making CORS requests that would change the state of your system (e.g. User subscribes to or unsubscribes from a mailing list) the first two steps you need to make do are:
...
It's very important that these are done first before processing the request, this provides protection against CSRF attacks.
