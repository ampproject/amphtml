...
<table>
  ...
  <tr>
    ...
    the <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#autofocus"><code>autofocus</code> attribute</a>,
    or any of its descendants is, the <code>autofocus</code> element gains focus.</td>
  </tr>
  <tr>
