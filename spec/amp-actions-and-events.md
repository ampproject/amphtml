...
<table>
  ...
  <tr>
    ...
    <td>When <code>navigate</code> is <code>false</code> or unspecified, <code>goBack</code> will attempt to go back in history while remaining in the current document. When <code>navigate</code> is <code>true</code>, the action will allow cross-document navigation, similar to [history.back](https://developer.mozilla.org/en-US/docs/Web/API/History/back).</td>
  </tr>
  <tr>
