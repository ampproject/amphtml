...
;
var $serializeMessage$$module$src$3p_frame_messaging$$ = function($type$jscomp$123$$, $sentinel$$, $data$jscomp$45_message$jscomp$33$$, $rtvVersion$$) {
  $data$jscomp$45_message$jscomp$33$$ = void 0 === $data$jscomp$45_message$jscomp$33$$ ? {} : $data$jscomp$45_message$jscomp$33$$;
  $data$jscomp$45_message$jscomp$33$$.type = $type$jscomp$123$$;
  $data$jscomp$45_message$jscomp$33$$.sentinel = $sentinel$$;
  return "amp-" + ((void 0 === $rtvVersion$$ ? null : $rtvVersion$$) || "") + JSON.stringify($data$jscomp$45_message$jscomp$33$$);
}, $registerIniLoadListener$$module$src$inabox$utils$$ = function($ampdoc$jscomp$240$$) {
  var $win$jscomp$496$$ = $ampdoc$jscomp$240$$.$win$, $root$jscomp$93$$ = $ampdoc$jscomp$240$$.getRootNode();
  _.$whenContentIniLoad$$module$src$friendly_iframe_embed$$($ampdoc$jscomp$240$$, $win$jscomp$496$$, _.$Services$$module$src$services$viewportForDoc$$($ampdoc$jscomp$240$$).$getLayoutRect$($root$jscomp$93$$.documentElement || $root$jscomp$93$$.body || $root$jscomp$93$$)).then(function() {
    $win$jscomp$496$$.dispatchEvent(_.$createCustomEvent$$module$src$event_helper$$($win$jscomp$496$$, "amp-ini-load", null, {bubbles:!0}));
    $win$jscomp$496$$.parent && $win$jscomp$496$$.parent.postMessage("amp-ini-load", "*");
  });
}, $IframeMessagingClient$$module$3p$iframe_messaging_client$$ = function($win$jscomp$498$$) {
  this.$I$ = $win$jscomp$498$$;
  this.$K$ = _.$getMode$$module$src$mode$$().$rtvVersion$ || null;
  this.$G$ = $win$jscomp$498$$.parent;
  this.$F$ = null;
  this.$J$ = 1;
  this.$D$ = _.$map$$module$src$utils$object$$();
  $JSCompiler_StaticMethods_setupEventListener_$$(this);
}, $JSCompiler_StaticMethods_makeRequest$$ = function($JSCompiler_StaticMethods_makeRequest$self$$, $requestType$jscomp$2$$, $responseType$jscomp$4_unlisten$jscomp$31$$, $callback$jscomp$171$$) {
  $responseType$jscomp$4_unlisten$jscomp$31$$ = $JSCompiler_StaticMethods_registerCallback$$($JSCompiler_StaticMethods_makeRequest$self$$, $responseType$jscomp$4_unlisten$jscomp$31$$, $callback$jscomp$171$$);
  $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$$($JSCompiler_StaticMethods_makeRequest$self$$, $requestType$jscomp$2$$);
  return $responseType$jscomp$4_unlisten$jscomp$31$$;
}, $JSCompiler_StaticMethods_requestOnce$$ = function($JSCompiler_StaticMethods_requestOnce$self$$, $callback$jscomp$172$$) {
  var $unlisten$jscomp$32$$ = $JSCompiler_StaticMethods_registerCallback$$($JSCompiler_StaticMethods_requestOnce$self$$, "position", function($JSCompiler_StaticMethods_requestOnce$self$$) {
    $unlisten$jscomp$32$$();
    $callback$jscomp$172$$($JSCompiler_StaticMethods_requestOnce$self$$);
  });
  $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$$($JSCompiler_StaticMethods_requestOnce$self$$, "send-positions");
}, $JSCompiler_StaticMethods_registerCallback$$ = function($JSCompiler_StaticMethods_registerCallback$self$$, $messageType$jscomp$4$$, $callback$jscomp$173$$) {
  $messageType$jscomp$4$$ in $JSCompiler_StaticMethods_registerCallback$self$$.$D$ || ($JSCompiler_StaticMethods_registerCallback$self$$.$D$[$messageType$jscomp$4$$] = new _.$Observable$$module$src$observable$$);
  return $JSCompiler_StaticMethods_registerCallback$self$$.$D$[$messageType$jscomp$4$$].add($callback$jscomp$173$$);
}, $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$$ = function($JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$self$$, $type$jscomp$209$$, $opt_payload$jscomp$5$$) {
  $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$self$$.$G$.postMessage($serializeMessage$$module$src$3p_frame_messaging$$($type$jscomp$209$$, $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$self$$.$F$, $opt_payload$jscomp$5$$, $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$self$$.$K$), "*");
}, $JSCompiler_StaticMethods_setupEventListener_$$ = function($JSCompiler_StaticMethods_setupEventListener_$self$$) {
  _.$listen$$module$src$3p_frame_messaging$$($JSCompiler_StaticMethods_setupEventListener_$self$$.$I$, function($event$jscomp$259_messageType$jscomp$inline_5538$$) {
    if ($event$jscomp$259_messageType$jscomp$inline_5538$$.source == $JSCompiler_StaticMethods_setupEventListener_$self$$.$G$) {
      var $message$jscomp$93$$ = _.$deserializeMessage$$module$src$3p_frame_messaging$$($event$jscomp$259_messageType$jscomp$inline_5538$$.data);
      $message$jscomp$93$$ && $message$jscomp$93$$.sentinel == $JSCompiler_StaticMethods_setupEventListener_$self$$.$F$ && ($message$jscomp$93$$.origin = $event$jscomp$259_messageType$jscomp$inline_5538$$.origin, $event$jscomp$259_messageType$jscomp$inline_5538$$ = $message$jscomp$93$$.type, $event$jscomp$259_messageType$jscomp$inline_5538$$ in $JSCompiler_StaticMethods_setupEventListener_$self$$.$D$ && $JSCompiler_StaticMethods_setupEventListener_$self$$.$D$[$event$jscomp$259_messageType$jscomp$inline_5538$$].$fire$($message$jscomp$93$$));
    }
  });
}, $createIframeMessagingClient$$module$src$inabox$inabox_iframe_messaging_client$$ = function($win$jscomp$502$$) {
  var $iframeClient$$ = new $IframeMessagingClient$$module$3p$iframe_messaging_client$$($win$jscomp$502$$), $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$ = _.$tryParseJson$$module$src$json$$($win$jscomp$502$$.name), $sentinel$jscomp$10$$ = null;
  $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$ && $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$._context && ($sentinel$jscomp$10$$ = $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$._context.sentinel);
  $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$ = $sentinel$jscomp$10$$ || String($win$jscomp$502$$.Math.random()).substr(2);
  $iframeClient$$.$F$ = $dataObject$jscomp$2_sentinel$jscomp$inline_5542$$;
  $iframeClient$$.$G$ = $win$jscomp$502$$.top;
  return $iframeClient$$;
}, $prepareBodyForOverlay$$module$src$inabox$inabox_viewport$$ = function($win$jscomp$504$$, $bodyElement$$) {
  return _.$JSCompiler_StaticMethods_runPromise$$(_.$Services$$module$src$services$vsyncFor$$($win$jscomp$504$$), {measure:function($bodyElement$$) {
    $bodyElement$$.width = $win$jscomp$504$$.innerWidth;
    $bodyElement$$.height = $win$jscomp$504$$.innerHeight;
  }, $mutate$:function($win$jscomp$504$$) {
    _.$setImportantStyles$$module$src$style$$($bodyElement$$, {background:"transparent", left:"50%", top:"50%", right:"auto", bottom:"auto", position:"absolute", height:_.$px$$module$src$style$$($win$jscomp$504$$.height), width:_.$px$$module$src$style$$($win$jscomp$504$$.width), "margin-top":_.$px$$module$src$style$$(-$win$jscomp$504$$.height / 2), "margin-left":_.$px$$module$src$style$$(-$win$jscomp$504$$.width / 2)});
  }}, {});
}, $resetBodyForOverlay$$module$src$inabox$inabox_viewport$$ = function($win$jscomp$505$$, $bodyElement$jscomp$1$$) {
  return _.$JSCompiler_StaticMethods_mutatePromise$$(_.$Services$$module$src$services$vsyncFor$$($win$jscomp$505$$), function() {
    _.$resetStyles$$module$src$style$$($bodyElement$jscomp$1$$, "position left top right bottom width height margin-left margin-top".split(" "));
  });
}, $ViewportBindingInabox$$module$src$inabox$inabox_viewport$$ = function($win$jscomp$506$$) {
  var $$jscomp$this$jscomp$1363$$ = this;
  this.$win$ = $win$jscomp$506$$;
  this.$J$ = new _.$Observable$$module$src$observable$$;
  this.$I$ = new _.$Observable$$module$src$observable$$;
  var $boxWidth$jscomp$1$$ = $win$jscomp$506$$.innerWidth, $boxHeight$$ = $win$jscomp$506$$.innerHeight;
  this.$viewportRect_$ = _.$layoutRectLtwh$$module$src$layout_rect$$(0, 0, $boxWidth$jscomp$1$$, $boxHeight$$);
  this.$D$ = _.$layoutRectLtwh$$module$src$layout_rect$$(0, $boxHeight$$ + 1, $boxWidth$jscomp$1$$, $boxHeight$$);
  this.$F$ = _.$getService$$module$src$service$$($win$jscomp$506$$, "iframeMessagingClient");
  this.$G$ = null;
  this.$K$ = _.$throttle$$module$src$utils$rate_limit$$(this.$win$, function() {
    $$jscomp$this$jscomp$1363$$.$J$.$fire$();
  }, 100);
  this.$useLayers_$ = _.$isExperimentOn$$module$src$experiments$$(this.$win$, "layers");
  "inabox-viewport";
}, $JSCompiler_StaticMethods_listenForPosition_$$ = function($JSCompiler_StaticMethods_listenForPosition_$self$$) {
  $JSCompiler_StaticMethods_makeRequest$$($JSCompiler_StaticMethods_listenForPosition_$self$$.$F$, "send-positions", "position", function($data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$) {
    "inabox-viewport";
    var $oldViewportRect$$ = $JSCompiler_StaticMethods_listenForPosition_$self$$.$viewportRect_$;
    $JSCompiler_StaticMethods_listenForPosition_$self$$.$viewportRect_$ = $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.viewportRect;
    $JSCompiler_StaticMethods_updateBoxRect_$$($JSCompiler_StaticMethods_listenForPosition_$self$$, $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.targetRect);
    $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$ = $JSCompiler_StaticMethods_listenForPosition_$self$$.$viewportRect_$;
    $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.width == $oldViewportRect$$.width && $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.height == $oldViewportRect$$.height || $JSCompiler_StaticMethods_listenForPosition_$self$$.$I$.$fire$();
    $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$ = $JSCompiler_StaticMethods_listenForPosition_$self$$.$viewportRect_$;
    $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.left == $oldViewportRect$$.left && $data$jscomp$226_newRect$jscomp$inline_6616_newRect$jscomp$inline_6619$$.top == $oldViewportRect$$.top || $JSCompiler_StaticMethods_listenForPosition_$self$$.$K$();
  });
}, $JSCompiler_StaticMethods_updateBoxRect_$$ = function($JSCompiler_StaticMethods_updateBoxRect_$self$$, $boxRect_positionRect$jscomp$5$$) {
  if ($boxRect_positionRect$jscomp$5$$) {
    $boxRect_positionRect$jscomp$5$$ = _.$moveLayoutRect$$module$src$layout_rect$$($boxRect_positionRect$jscomp$5$$, $JSCompiler_StaticMethods_updateBoxRect_$self$$.$viewportRect_$.left, $JSCompiler_StaticMethods_updateBoxRect_$self$$.$viewportRect_$.top);
    var $oldRect$jscomp$inline_5548$$ = $JSCompiler_StaticMethods_updateBoxRect_$self$$.$D$;
    if ($boxRect_positionRect$jscomp$5$$.left != $oldRect$jscomp$inline_5548$$.left || $boxRect_positionRect$jscomp$5$$.top != $oldRect$jscomp$inline_5548$$.top || $boxRect_positionRect$jscomp$5$$.width != $oldRect$jscomp$inline_5548$$.width || $boxRect_positionRect$jscomp$5$$.height != $oldRect$jscomp$inline_5548$$.height) {
      "inabox-viewport", $JSCompiler_StaticMethods_updateBoxRect_$self$$.$D$ = $boxRect_positionRect$jscomp$5$$, $JSCompiler_StaticMethods_remeasureAllElements_$$($JSCompiler_StaticMethods_updateBoxRect_$self$$);
    }
  }
}, $JSCompiler_StaticMethods_remeasureAllElements_$$ = function($JSCompiler_StaticMethods_remeasureAllElements_$self$$) {
  _.$Services$$module$src$services$resourcesForDoc$$($JSCompiler_StaticMethods_remeasureAllElements_$self$$.$win$.document.documentElement).get().forEach(function($JSCompiler_StaticMethods_remeasureAllElements_$self$$) {
    return $JSCompiler_StaticMethods_remeasureAllElements_$self$$.measure();
  });
}, $JSCompiler_StaticMethods_tryToEnterOverlayMode_$$ = function($JSCompiler_StaticMethods_tryToEnterOverlayMode_$self$$) {
  return $prepareBodyForOverlay$$module$src$inabox$inabox_viewport$$($JSCompiler_StaticMethods_tryToEnterOverlayMode_$self$$.$win$, $JSCompiler_StaticMethods_tryToEnterOverlayMode_$self$$.$win$.document.body).then(function() {
    return $JSCompiler_StaticMethods_requestFullOverlayFrame_$$($JSCompiler_StaticMethods_tryToEnterOverlayMode_$self$$);
  });
}, $JSCompiler_StaticMethods_leaveOverlayMode_$$ = function($JSCompiler_StaticMethods_leaveOverlayMode_$self$$) {
  return $JSCompiler_StaticMethods_requestCancelFullOverlayFrame_$$($JSCompiler_StaticMethods_leaveOverlayMode_$self$$).then(function() {
    return $resetBodyForOverlay$$module$src$inabox$inabox_viewport$$($JSCompiler_StaticMethods_leaveOverlayMode_$self$$.$win$, $JSCompiler_StaticMethods_leaveOverlayMode_$self$$.$win$.document.body);
  });
}, $JSCompiler_StaticMethods_requestFullOverlayFrame_$$ = function($JSCompiler_StaticMethods_requestFullOverlayFrame_$self$$) {
  return new window.Promise(function($resolve$jscomp$115$$, $reject$jscomp$42$$) {
    var $unlisten$jscomp$33$$ = $JSCompiler_StaticMethods_makeRequest$$($JSCompiler_StaticMethods_requestFullOverlayFrame_$self$$.$F$, "full-overlay-frame", "full-overlay-frame-response", function($response$jscomp$89$$) {
      $unlisten$jscomp$33$$();
      $response$jscomp$89$$.success ? ($JSCompiler_StaticMethods_updateBoxRect_$$($JSCompiler_StaticMethods_requestFullOverlayFrame_$self$$, $response$jscomp$89$$.boxRect), $resolve$jscomp$115$$()) : $reject$jscomp$42$$("Request to open lightbox rejected by host document");
    });
  });
}, $JSCompiler_StaticMethods_requestCancelFullOverlayFrame_$$ = function($JSCompiler_StaticMethods_requestCancelFullOverlayFrame_$self$$) {
  return new window.Promise(function($resolve$jscomp$116$$) {
    var $unlisten$jscomp$34$$ = $JSCompiler_StaticMethods_makeRequest$$($JSCompiler_StaticMethods_requestCancelFullOverlayFrame_$self$$.$F$, "cancel-full-overlay-frame", "cancel-full-overlay-frame-response", function($response$jscomp$90$$) {
      $unlisten$jscomp$34$$();
      $JSCompiler_StaticMethods_updateBoxRect_$$($JSCompiler_StaticMethods_requestCancelFullOverlayFrame_$self$$, $response$jscomp$90$$.boxRect);
      $resolve$jscomp$116$$();
    });
  });
}, $installInaboxViewportService$$module$src$inabox$inabox_viewport$$ = function($ampdoc$jscomp$241$$) {
  var $binding$jscomp$11$$ = new $ViewportBindingInabox$$module$src$inabox$inabox_viewport$$($ampdoc$jscomp$241$$.$win$), $viewer$jscomp$55$$ = _.$Services$$module$src$services$viewerForDoc$$($ampdoc$jscomp$241$$);
  _.$registerServiceBuilderForDoc$$module$src$service$$($ampdoc$jscomp$241$$, "viewport", function() {
    return new _.$Viewport$$module$src$service$viewport$viewport_impl$$($ampdoc$jscomp$241$$, $binding$jscomp$11$$, $viewer$jscomp$55$$);
  }, !0);
};
$IframeMessagingClient$$module$3p$iframe_messaging_client$$.prototype.getData = function($requestType$jscomp$1$$, $payload$jscomp$39$$, $callback$jscomp$170$$) {
  var $messageId$jscomp$5$$ = this.$J$++, $unlisten$jscomp$30$$ = $JSCompiler_StaticMethods_registerCallback$$(this, $requestType$jscomp$1$$ + "-result", function($requestType$jscomp$1$$) {
    $requestType$jscomp$1$$.messageId === $messageId$jscomp$5$$ && ($unlisten$jscomp$30$$(), $callback$jscomp$170$$($requestType$jscomp$1$$.content));
  }), $data$jscomp$225$$ = {};
  $data$jscomp$225$$.payload = $payload$jscomp$39$$;
  $data$jscomp$225$$.messageId = $messageId$jscomp$5$$;
  $JSCompiler_StaticMethods_IframeMessagingClient$$module$3p$iframe_messaging_client_prototype$sendMessage$$(this, $requestType$jscomp$1$$, $data$jscomp$225$$);
};
_.$JSCompiler_prototypeAlias$$ = $ViewportBindingInabox$$module$src$inabox$inabox_viewport$$.prototype;
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$connect$ = function() {
  $JSCompiler_StaticMethods_listenForPosition_$$(this);
};
_.$JSCompiler_prototypeAlias$$.$getLayoutRect$ = function($b$jscomp$266_el$jscomp$182$$) {
  $b$jscomp$266_el$jscomp$182$$ = $b$jscomp$266_el$jscomp$182$$.getBoundingClientRect();
  var $left$jscomp$22$$ = $b$jscomp$266_el$jscomp$182$$.left, $top$jscomp$28$$ = $b$jscomp$266_el$jscomp$182$$.top;
  this.$useLayers_$ && ($left$jscomp$22$$ -= this.$viewportRect_$.left, $top$jscomp$28$$ -= this.$viewportRect_$.top);
  return _.$layoutRectLtwh$$module$src$layout_rect$$(Math.round($left$jscomp$22$$ + this.$D$.left), Math.round($top$jscomp$28$$ + this.$D$.top), Math.round($b$jscomp$266_el$jscomp$182$$.width), Math.round($b$jscomp$266_el$jscomp$182$$.height));
};
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$onScroll$ = function($callback$jscomp$174$$) {
  this.$J$.add($callback$jscomp$174$$);
};
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$onResize$ = function($callback$jscomp$175$$) {
  this.$I$.add($callback$jscomp$175$$);
};
_.$JSCompiler_prototypeAlias$$.$getSize$ = function() {
  return {width:this.$viewportRect_$.width, height:this.$viewportRect_$.height};
};
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$getScrollTop$ = function() {
...
_.$JSCompiler_prototypeAlias$$.$updateLightboxMode$ = function($lightboxMode$$) {
  return $lightboxMode$$ ? $JSCompiler_StaticMethods_tryToEnterOverlayMode_$$(this) : $JSCompiler_StaticMethods_leaveOverlayMode_$$(this);
};
_.$JSCompiler_prototypeAlias$$.$getRootClientRectAsync$ = function() {
  var $$jscomp$this$jscomp$1365$$ = this;
  this.$G$ || (this.$G$ = new window.Promise(function($resolve$jscomp$114$$) {
    $JSCompiler_StaticMethods_requestOnce$$($$jscomp$this$jscomp$1365$$.$F$, function($data$jscomp$227$$) {
      $$jscomp$this$jscomp$1365$$.$G$ = null;
      $resolve$jscomp$114$$($data$jscomp$227$$.$targetRect$);
    });
  }));
  return this.$G$;
};
...
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$updatePaddingTop$ = function() {
};
_.$JSCompiler_prototypeAlias$$.$hideViewerHeader$ = function() {
};
_.$JSCompiler_prototypeAlias$$.$showViewerHeader$ = function() {
};
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$disableScroll$ = function() {
};
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$resetScroll$ = function() {
...
_.$JSCompiler_prototypeAlias$$.$ViewportBindingDef$$module$src$service$viewport$viewport_binding_def_prototype$setScrollTop$ = function() {
};
_.$JSCompiler_prototypeAlias$$.getScrollWidth = function() {
  return 0;
};
...
_.$getMode$$module$src$mode$$(window.self).runtime = "inabox";
var $JSCompiler_temp_const$jscomp$1070$$ = _.$getMode$$module$src$mode$$(window.self), $JSCompiler_inline_result$jscomp$1071$$, $a4aIdMetaTag$jscomp$inline_5551$$ = window.self.document.head.querySelector('meta[name="amp4ads-id"]');
$JSCompiler_inline_result$jscomp$1071$$ = $a4aIdMetaTag$jscomp$inline_5551$$ ? $a4aIdMetaTag$jscomp$inline_5551$$.getAttribute("content") : null;
$JSCompiler_temp_const$jscomp$1070$$.$a4aId$ = $JSCompiler_inline_result$jscomp$1071$$;
var $ampdocService$$module$src$inabox$amp_inabox$$;
try {
  _.$installErrorReporting$$module$src$error$$(), _.$installDocService$$module$src$service$ampdoc_impl$$(!0), $ampdocService$$module$src$inabox$amp_inabox$$ = _.$Services$$module$src$services$ampdocServiceFor$$(window.self);
} catch ($e$384$$) {
  throw _.$makeBodyVisibleRecovery$$module$src$style_installer$$(window.self.document), $e$384$$;
}
_.$startupChunk$$module$src$chunk$$(window.self.document, function() {
  var $ampdoc$jscomp$242$$ = $ampdocService$$module$src$inabox$amp_inabox$$.$getAmpDoc$(window.self.document);
  _.$installPerformanceService$$module$src$service$performance_impl$$();
  var $perf$jscomp$4$$ = _.$Services$$module$src$services$performanceFor$$(window.self);
  $perf$jscomp$4$$.$D$("is");
  window.self.document.documentElement.classList.add("i-amphtml-inabox");
  _.$installStylesForDoc$$module$src$style_installer$$($ampdoc$jscomp$242$$, "html{overflow-x:hidden!important}body,html{height:auto!important}html.i-amphtml-fie{height:100%!important;width:100%!important}body{margin:0!important;-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;-ms-text-size-adjust:100%;text-size-adjust:100%}[hidden]{display:none!important}html.i-amphtml-singledoc.i-amphtml-embedded{-ms-touch-action:pan-y;touch-action:pan-y}html.i-amphtml-fie>body,html.i-amphtml-singledoc>body{overflow:visible!important}html.i-amphtml-fie:not(.i-amphtml-inabox)>body,html.i-amphtml-singledoc:not(.i-amphtml-inabox)>body{position:relative!important}html.i-amphtml-webview>body{overflow-x:hidden!important;overflow-y:visible!important;min-height:100vh!important}html.i-amphtml-ios-embed-legacy>body{overflow-x:hidden!important;overflow-y:auto!important;position:absolute!important}html.i-amphtml-ios-embed{overflow-y:auto!important;position:static}#i-amphtml-wrapper{overflow-x:hidden!important;overflow-y:auto!important;position:absolute!important;top:0!important;left:0!important;right:0!important;bottom:0!important;margin:0!important;display:block!important}html.i-amphtml-ios-embed.i-amphtml-ios-overscroll,html.i-amphtml-ios-embed.i-amphtml-ios-overscroll>#i-amphtml-wrapper{-webkit-overflow-scrolling:touch!important}#i-amphtml-wrapper>body{position:relative!important;border-top:1px solid transparent!important}html.i-amphtml-ios-embed-sd{overflow:hidden!important;position:static!important}html.i-amphtml-ios-embed-sd>body,html.i-amphtml-singledoc.i-amphtml-ios-embed-sd>body{position:absolute!important;top:0!important;left:0!important;right:0!important;bottom:0!important;overflow:hidden!important}.i-amphtml-body-minheight>body{min-height:calc(100vh + 1px)}.i-amphtml-element{display:inline-block}.i-amphtml-blurry-placeholder{-webkit-transition:opacity 0.3s cubic-bezier(0.0,0.0,0.2,1)!important;transition:opacity 0.3s cubic-bezier(0.0,0.0,0.2,1)!important}[layout=nodisplay]:not(.i-amphtml-element){display:none!important}.i-amphtml-layout-fixed,[layout=fixed][width][height]:not(.i-amphtml-layout-fixed){display:inline-block;position:relative}.i-amphtml-layout-responsive,[layout=responsive][width][height]:not(.i-amphtml-layout-responsive),[width][height][sizes]:not(.i-amphtml-layout-responsive){display:block;position:relative}.i-amphtml-layout-intrinsic{display:inline-block;position:relative;max-width:100%}.i-amphtml-intrinsic-sizer{max-width:100%;display:block!important}.i-amphtml-layout-container,.i-amphtml-layout-fixed-height,[layout=container],[layout=fixed-height][height]{display:block;position:relative}.i-amphtml-layout-fill,[layout=fill]:not(.i-amphtml-layout-fill){display:block;overflow:hidden!important;position:absolute;top:0;left:0;bottom:0;right:0}.i-amphtml-layout-flex-item,[layout=flex-item]:not(.i-amphtml-layout-flex-item){display:block;position:relative;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto}.i-amphtml-layout-fluid{position:relative}.i-amphtml-layout-size-defined{overflow:hidden!important}.i-amphtml-layout-awaiting-size{position:absolute!important;top:auto!important;bottom:auto!important}i-amphtml-sizer{display:block!important}.i-amphtml-blurry-placeholder,.i-amphtml-fill-content{display:block;height:0;max-height:100%;max-width:100%;min-height:100%;min-width:100%;width:0;margin:auto}.i-amphtml-layout-size-defined .i-amphtml-fill-content{position:absolute;top:0;left:0;bottom:0;right:0}.i-amphtml-layout-intrinsic .i-amphtml-sizer{max-width:100%}.i-amphtml-replaced-content,.i-amphtml-screen-reader{padding:0!important;border:none!important}.i-amphtml-screen-reader{position:fixed!important;top:0px!important;left:0px!important;width:4px!important;height:4px!important;opacity:0!important;overflow:hidden!important;margin:0!important;display:block!important;visibility:visible!important}.i-amphtml-screen-reader~.i-amphtml-screen-reader{left:8px!important}.i-amphtml-screen-reader~.i-amphtml-screen-reader~.i-amphtml-screen-reader{left:12px!important}.i-amphtml-screen-reader~.i-amphtml-screen-reader~.i-amphtml-screen-reader~.i-amphtml-screen-reader{left:16px!important}.i-amphtml-unresolved{position:relative;overflow:hidden!important}#i-amphtml-wrapper.i-amphtml-scroll-disabled,.i-amphtml-scroll-disabled{overflow-x:hidden!important;overflow-y:hidden!important}.i-amphtml-select-disabled{-webkit-user-select:none!important;-moz-user-select:none!important;-ms-user-select:none!important;user-select:none!important}.i-amphtml-notbuilt,[layout]:not(.i-amphtml-element){position:relative;overflow:hidden!important;color:transparent!important}.i-amphtml-notbuilt:not(.i-amphtml-layout-container)>*,[layout]:not([layout=container]):not(.i-amphtml-element)>*{display:none}.i-amphtml-ghost{visibility:hidden!important}.i-amphtml-element>[placeholder],[layout]:not(.i-amphtml-element)>[placeholder]{display:block}.i-amphtml-element>[placeholder].amp-hidden,.i-amphtml-element>[placeholder].hidden{visibility:hidden}.i-amphtml-element:not(.amp-notsupported)>[fallback],.i-amphtml-layout-container>[placeholder].amp-hidden,.i-amphtml-layout-container>[placeholder].hidden{display:none}.i-amphtml-layout-size-defined>[fallback],.i-amphtml-layout-size-defined>[placeholder]{position:absolute!important;top:0!important;left:0!important;right:0!important;bottom:0!important;z-index:1}.i-amphtml-notbuilt>[placeholder]{display:block!important}.i-amphtml-hidden-by-media-query{display:none!important}.i-amphtml-element-error{background:red!important;color:#fff!important;position:relative!important}.i-amphtml-element-error:before{content:attr(error-message)}i-amp-scroll-container,i-amphtml-scroll-container{position:absolute;top:0;left:0;right:0;bottom:0;display:block}i-amp-scroll-container.amp-active,i-amphtml-scroll-container.amp-active{overflow:auto;-webkit-overflow-scrolling:touch}.i-amphtml-loading-container{display:block!important;pointer-events:none;z-index:1}.i-amphtml-notbuilt>.i-amphtml-loading-container{display:block!important}.i-amphtml-loading-container.amp-hidden{visibility:hidden}.i-amphtml-loader-line{position:absolute;top:0;left:0;right:0;height:1px;overflow:hidden!important;background-color:hsla(0,0%,59.2%,0.2);display:block}.i-amphtml-loader-moving-line{display:block;position:absolute;width:100%;height:100%!important;background-color:hsla(0,0%,59.2%,0.65);z-index:2}@-webkit-keyframes i-amphtml-loader-line-moving{0%{-webkit-transform:translateX(-100%);transform:translateX(-100%)}to{-webkit-transform:translateX(100%);transform:translateX(100%)}}@keyframes i-amphtml-loader-line-moving{0%{-webkit-transform:translateX(-100%);transform:translateX(-100%)}to{-webkit-transform:translateX(100%);transform:translateX(100%)}}.i-amphtml-loader-line.amp-active .i-amphtml-loader-moving-line{-webkit-animation:i-amphtml-loader-line-moving 4s ease infinite;animation:i-amphtml-loader-line-moving 4s ease infinite}.i-amphtml-loader{position:absolute;display:block;height:10px;top:50%;left:50%;-webkit-transform:translateX(-50%) translateY(-50%);transform:translateX(-50%) translateY(-50%);-webkit-transform-origin:50% 50%;transform-origin:50% 50%;white-space:nowrap}.i-amphtml-loader.amp-active .i-amphtml-loader-dot{-webkit-animation:i-amphtml-loader-dots 2s infinite;animation:i-amphtml-loader-dots 2s infinite}.i-amphtml-loader-dot{position:relative;display:inline-block;height:10px;width:10px;margin:2px;border-radius:100%;background-color:rgba(0,0,0,0.3);box-shadow:2px 2px 2px 1px rgba(0,0,0,0.2);will-change:transform}.i-amphtml-loader .i-amphtml-loader-dot:first-child{-webkit-animation-delay:0s;animation-delay:0s}.i-amphtml-loader .i-amphtml-loader-dot:nth-child(2){-webkit-animation-delay:.1s;animation-delay:.1s}.i-amphtml-loader .i-amphtml-loader-dot:nth-child(3){-webkit-animation-delay:.2s;animation-delay:.2s}@-webkit-keyframes i-amphtml-loader-dots{0%,to{-webkit-transform:scale(.7);transform:scale(.7);background-color:rgba(0,0,0,0.3)}50%{-webkit-transform:scale(.8);transform:scale(.8);background-color:rgba(0,0,0,0.5)}}@keyframes i-amphtml-loader-dots{0%,to{-webkit-transform:scale(.7);transform:scale(.7);background-color:rgba(0,0,0,0.3)}50%{-webkit-transform:scale(.8);transform:scale(.8);background-color:rgba(0,0,0,0.5)}}.i-amphtml-element>[overflow]{cursor:pointer;position:relative;z-index:2;visibility:hidden}.i-amphtml-element>[overflow].amp-visible{visibility:visible}template{display:none!important}.amp-border-box,.amp-border-box *,.amp-border-box :after,.amp-border-box :before{box-sizing:border-box}amp-pixel{display:none!important}amp-instagram{padding:64px 0px 0px!important;background-color:#fff}amp-analytics,amp-story-auto-ads{position:fixed!important;top:0!important;width:1px!important;height:1px!important;overflow:hidden!important;visibility:hidden}html.i-amphtml-fie>amp-analytics{position:initial!important}amp-iframe iframe{box-sizing:border-box!important}[amp-access][amp-access-hide]{display:none}[subscriptions-dialog],body:not(.i-amphtml-subs-ready) [subscriptions-action],body:not(.i-amphtml-subs-ready) [subscriptions-section]{display:none!important}[visible-when-invalid]:not(.visible),amp-experiment,amp-live-list>[update],amp-share-tracking,form [submit-error],form [submit-success],form [submitting]{display:none}.i-amphtml-jank-meter{position:fixed;background-color:rgba(232,72,95,0.5);bottom:0;right:0;color:#fff;font-size:16px;z-index:1000;padding:5px}amp-accordion{display:block!important}amp-accordion>section{float:none!important}amp-accordion>section>*{float:none!important;display:block!important;overflow:hidden!important;position:relative!important}.i-amphtml-accordion-content,.i-amphtml-accordion-header,amp-accordion,amp-accordion>section{margin:0}.i-amphtml-accordion-header{cursor:pointer;background-color:#efefef;padding-right:20px;border:1px solid #dfdfdf}amp-accordion>section>:last-child{display:none!important}amp-accordion>section[expanded]>:last-child{display:block!important}amp-list[resizable-children]>.i-amphtml-loading-container.amp-hidden{display:none!important}amp-list[load-more] [load-more-button],amp-list[load-more] [load-more-end],amp-list[load-more] [load-more-failed],amp-list[load-more] [load-more-loading]{display:none}amp-story-page,amp-story[standalone]{display:block!important;height:100%!important;margin:0!important;padding:0!important;overflow:hidden!important;width:100%!important}amp-story[standalone]{background-color:#fff!important;position:relative!important}amp-story-page{background-color:#757575}amp-story .i-amphtml-loader{display:none!important}[amp-fx^=fly-in]{visibility:hidden}amp-addthis[data-widget-type=floating]{position:fixed!important;width:100%!important;height:50px;bottom:0}\n/*# sourceURL=/css/amp.css*/html.i-amphtml-inabox{width:100%!important;height:100%!important}", 
  function() {
    _.$startupChunk$$module$src$chunk$$(window.self.document, function() {
      _.$installRuntimeServices$$module$src$runtime$$(window.self);
      _.$fontStylesheetTimeout$$module$src$font_stylesheet_timeout$$();
      var $win$jscomp$inline_5553$$ = window.self;
      _.$registerServiceBuilder$$module$src$service$$($win$jscomp$inline_5553$$, "iframeMessagingClient", $createIframeMessagingClient$$module$src$inabox$inabox_iframe_messaging_client$$.bind(null, $win$jscomp$inline_5553$$), !0);
      _.$installViewerServiceForDoc$$module$src$service$viewer_impl$$($ampdoc$jscomp$242$$);
      $installInaboxViewportService$$module$src$inabox$inabox_viewport$$($ampdoc$jscomp$242$$);
      _.$installAmpdocServices$$module$src$runtime$$($ampdoc$jscomp$242$$);
      _.$JSCompiler_StaticMethods_coreServicesAvailable$$($perf$jscomp$4$$);
      _.$maybeTrackImpression$$module$src$impression$$();
      $registerIniLoadListener$$module$src$inabox$utils$$($ampdoc$jscomp$242$$);
    });
    _.$startupChunk$$module$src$chunk$$(window.self.document, function() {
      _.$installBuiltins$$module$src$runtime$$();
    });
    ...
    _.$startupChunk$$module$src$chunk$$(window.self.document, function() {
      _.$stubElementsForDoc$$module$src$service$custom_element_registry$$($ampdoc$jscomp$242$$);
    });
    _.$startupChunk$$module$src$chunk$$(window.self.document, function() {
      _.$Navigation$$module$src$service$navigation$installAnchorClickInterceptor$$($ampdoc$jscomp$242$$, window.self);
      _.$maybeValidate$$module$src$validator_integration$$();
      _.$makeBodyVisible$$module$src$style_installer$$();
    });
    _.$startupChunk$$module$src$chunk$$(window.self.document, function() {
      $perf$jscomp$4$$.$D$("e_is");
      var $JSCompiler_StaticMethods_ampInitComplete$self$jscomp$inline_5555$$ = _.$Services$$module$src$services$resourcesForDoc$$($ampdoc$jscomp$242$$);
      $JSCompiler_StaticMethods_ampInitComplete$self$jscomp$inline_5555$$.$V$ = !0;
      _.$JSCompiler_StaticMethods_schedulePass$$($JSCompiler_StaticMethods_ampInitComplete$self$jscomp$inline_5555$$);
      $perf$jscomp$4$$.$F$();
    });
  }, !0, "amp-runtime");
});
