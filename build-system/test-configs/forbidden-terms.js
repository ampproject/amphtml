...
const forbiddenTermsGlobal = {
  ...
  'installPositionObserverServiceForDoc': {
    ...
    allowlist: [
      ...
      'bento/components/amp-next-page/visibility-observer.js',
  ...
  '\\.sendMessage\\(': {
    ...
    allowlist: [
      ...
      'bento/components/amp-story/amp-story-viewer-messaging-handler.js',
  ...
  'cidForDoc|cidForDocOrNull': {
    ...
    allowlist: [
      ...
      'bento/components/amp-experiment/variant.js',
  ...
  'localStorage': {
    ...
    allowlist: [
      ...
      'bento/components/amp-story/history.js',
      'extensions/amp-web-push/0.1/amp-web-push-helper-frame.js',
  ...
  'isBuildRenderBlocking': {
    ...
    allowlist: [
      ...
      'bento/components/amp-experiment/amp-experiment.js',
    ],
  },
  '^describe\n*\\s*[\\.|\\(]': {
    message:
  ...
  '@storybook/addon-knobs': {
    ...
    allowlist: [
      ...
      'bento/components/amp-date-display/storybook/Basic.amp.js',
      'bento/components/amp-date-display/storybook/Basic.js',
      'extensions/amp-iframe/0.1/storybook/Basic.amp.js',
      'bento/components/amp-iframe/storybook/Basic.amp.js',
      'extensions/amp-image-slider/0.1/storybook/Basic.amp.js',
      'bento/components/amp-inline-gallery/storybook/Basic.js',
      'bento/components/amp-lightbox/storybook/Basic.amp.js',
      'bento/components/amp-lightbox/storybook/Basic.js',
      'bento/components/amp-lightbox-gallery/storybook/Basic.amp.js',
      'bento/components/amp-lightbox-gallery/storybook/Basic.js',
      'bento/components/amp-render/storybook/Basic.js',
      'bento/components/amp-selector/storybook/Basic.amp.js',
      'bento/components/amp-selector/storybook/Basic.js',
      'extensions/amp-sidebar/0.1/storybook/Basic.amp.js',
      'bento/components/amp-sidebar/storybook/Basic.amp.js',
      'bento/components/amp-sidebar/storybook/Basic.js',
      'bento/components/amp-soundcloud/storybook/Basic.amp.js',
      'bento/components/amp-soundcloud/storybook/Basic.js',
      'bento/components/amp-stream-gallery/storybook/Basic.amp.js',
      'bento/components/amp-stream-gallery/storybook/Basic.js',
      'bento/components/amp-timeago/storybook/Basic.js',
      'extensions/amp-twitter/0.1/storybook/Basic.amp.js',
      'bento/components/amp-twitter/storybook/Basic.amp.js',
      'bento/components/amp-twitter/storybook/Basic.js',
      'bento/components/amp-video/storybook/Basic.amp.js',
      'bento/components/amp-video/storybook/Basic.js',
      'bento/components/amp-video-iframe/storybook/Basic.amp.js',
      'bento/components/amp-vimeo/storybook/Basic.amp.js',
      'bento/components/amp-vimeo/storybook/Basic.js',
      'bento/components/amp-wordpress-embed/storybook/Basic.amp.js',
      'extensions/amp-youtube/0.1/storybook/Basic.amp.js',
      'bento/components/amp-youtube/storybook/Basic.amp.js',
      'bento/components/amp-youtube/storybook/Basic.js',
...
const forbiddenTermsSrcInclusive = {
  ...
  'loadElementClass': {
    ...
    allowlist: [
      ...
      'bento/components/amp-sticky-ad/amp-sticky-ad.js',
    ],
  },
  'reject\\(\\)': {
    message:
  ...
  '\\.getTime\\(\\)': {
    ...
    allowlist: [
      ...
      'bento/components/amp-timeago/component.js',
  ...
  '\\.getLayoutBox': {
    ...
    allowlist: [
      ...
      'bento/components/amp-story/background-blur.js',
      'bento/components/amp-story/page-advancement.js',
    ],
  },
  '\\.getLayoutSize': {
    message: measurementApiDeprecated,
    allowlist: [
      ...
      'extensions/amp-fx-flying-carpet/0.1/amp-fx-flying-carpet.js',
      'extensions/amp-script/0.1/amp-script.js',
      'bento/components/amp-story/amp-story-page.js',
    ],
  },
  'onLayoutMeasure': {
    message: measurementApiDeprecated,
