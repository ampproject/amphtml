 ...
 * }>
 */
export const initTestsPath = ['testing/init-tests.js'];

export const karmaHtmlFixturesPath = 'test/fixtures/*.html';

export const fixturesExamplesPaths = [
...
export const builtRuntimePaths = [
  {
    pattern: 'dist/**/*.js',
    included: false,
    nocache: false,
...
export const commonIntegrationTestPaths = initTestsPath.concat(
  fixturesExamplesPaths,
  builtRuntimePaths
);

export const testPaths = commonIntegrationTestPaths.concat([
  'test/*/!(e2e)/**/*.js',
  'ads/**/test/test-*.js',
  'extensions/**/test/**/*.js',
]);
...
export const unitTestCrossBrowserPaths = [
  'test/unit/core/test-error.js',
  'test/unit/test-log.js',
];

export const integrationTestPaths = [
  'test/integration/**/*.js',
  'extensions/**/test/integration/**/*.js',
];

export const e2eTestPaths = ['test/e2e/*.js', 'extensions/**/test-e2e/*.js'];

export const devDashboardTestPaths = [
  'build-system/server/app-index/test/**/*.js',
];

export const jisonPath = 'extensions/**/*.jison';

export const lintGlobs = [
  '**/*.js',
 ...
 */
export const invalidWhitespaceGlobs = [
  '**/*.css',
  '**/*.html',
  '**/*.out',
  '**/*.out.cpponly',
 ...
 */
export const changelogIgnoreFileTypes =
