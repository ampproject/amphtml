...
import {cleanupBuildDir, printClosureConcurrency} from '../compile/compile.mjs';
import {createCtrlcHandler, exitCtrlcHandler} from '../common/ctrlcHandler.mjs';
import {cyan, green} from 'kleur/colors';
import {displayLifecycleDebugging} from '../compile/debug-compilation-lifecycle.mjs';
import {buildExtensions, parseExtensionFlags} from './extension-helpers.mjs';
import {buildVendorConfigs} from './3p-vendor-helpers.mjs';
import {compileCss, copyCss} from './css/index.mjs';
import {compileJison} from './compile-jison.mjs';
import {formatExtractedMessages} from '../compile/log-messages.mjs';
 ...
 * @return {Promise<void>}
 */
export async function runPreDistSteps(options) {
  cleanupBuildDir();
  await prebuild();
