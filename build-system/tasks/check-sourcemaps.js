...
const expectedFirstLineFileJs =
  'node_modules/@babel/runtime/helpers/esm/createClass.js'; // First file that is compiled into v0.js.
const expectedFirstLineCodeJs = 'function _defineProperties(target, props) {'; // First line of code in that file.
