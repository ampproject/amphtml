 ...
 * @return {number}
 */
export function numConfigs(str) {
 ...
 * @param {string} str
 */
export function sanityCheck(str) {
 ...
 * @return {string}
 */
export function prependConfig(configString, fileString) {
  return (
 ...
 * @return {!Promise<void>}
 */
export async function removeConfig(target) {
 ...
 * @return {Promise<void>}
 */
export async function prependGlobal() {
  if (!argv.target) {
