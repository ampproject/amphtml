...
const chaiMethodsAndProperties = [
  ...
  // {name: 'length', type: ChaiType.CHAINABLE_METHOD},   // DUP
  {name: 'length', type: ChaiType.CHAINABLE_METHOD},      
  // {name: 'lengthOf', type: ChaiType.CHAINABLE_METHOD}, // DUP
  ...
  // {name: 'match', type: ChaiType.METHOD},              // DUP
  {name: 'match', type: ChaiType.METHOD},                 
  // {name: 'matches', type: ChaiType.METHOD},            // DUP
