...
const chaiMethodsAndProperties = [
  {name: 'a', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'above', type: ChaiType_Enum.METHOD},
  {name: 'an', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'approximately', type: ChaiType_Enum.METHOD},
  {name: 'arguments', type: ChaiType_Enum.PROPERTY},
  {name: 'Arguments', type: ChaiType_Enum.PROPERTY},
  {name: 'below', type: ChaiType_Enum.METHOD},
  {name: 'by', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'change', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'changes', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'closeTo', type: ChaiType_Enum.METHOD},
  {name: 'contain', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'contains', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'decrease', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'decreases', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'empty', type: ChaiType_Enum.PROPERTY},
  {name: 'eq', type: ChaiType_Enum.METHOD},
  {name: 'eql', type: ChaiType_Enum.METHOD},
  {name: 'eqls', type: ChaiType_Enum.METHOD},
  {name: 'equal', type: ChaiType_Enum.METHOD},
  {name: 'equals', type: ChaiType_Enum.METHOD},
  {name: 'exist', type: ChaiType_Enum.PROPERTY},
  {name: 'extensible', type: ChaiType_Enum.PROPERTY},
  {name: 'false', type: ChaiType_Enum.PROPERTY},
  {name: 'finite', type: ChaiType_Enum.PROPERTY},
  {name: 'frozen', type: ChaiType_Enum.PROPERTY},
  {name: 'greaterThan', type: ChaiType_Enum.METHOD},
  {name: 'gt', type: ChaiType_Enum.METHOD},
  {name: 'gte', type: ChaiType_Enum.METHOD},
  {name: 'haveOwnProperty', type: ChaiType_Enum.METHOD},
  {name: 'haveOwnPropertyDescriptor', type: ChaiType_Enum.METHOD},
  {name: 'include', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'includes', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'increase', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'increases', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'instanceof', type: ChaiType_Enum.METHOD},
  {name: 'instanceOf', type: ChaiType_Enum.METHOD},
  {name: 'key', type: ChaiType_Enum.METHOD},
  {name: 'keys', type: ChaiType_Enum.METHOD},
  {name: 'least', type: ChaiType_Enum.METHOD},
  {name: 'length', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'lengthOf', type: ChaiType_Enum.CHAINABLE_METHOD},
  {name: 'lessThan', type: ChaiType_Enum.METHOD},
  {name: 'lt', type: ChaiType_Enum.METHOD},
  {name: 'lte', type: ChaiType_Enum.METHOD},
  {name: 'match', type: ChaiType_Enum.METHOD},
  {name: 'matches', type: ChaiType_Enum.METHOD},
  {name: 'members', type: ChaiType_Enum.METHOD},
  {name: 'most', type: ChaiType_Enum.METHOD},
  {name: 'NaN', type: ChaiType_Enum.PROPERTY},
  {name: 'null', type: ChaiType_Enum.PROPERTY},
  {name: 'ok', type: ChaiType_Enum.PROPERTY},
  {name: 'oneOf', type: ChaiType_Enum.METHOD},
  {name: 'ownProperty', type: ChaiType_Enum.METHOD},
  {name: 'ownPropertyDescriptor', type: ChaiType_Enum.METHOD},
  {name: 'property', type: ChaiType_Enum.METHOD},
  {name: 'respondsTo', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'respondTo', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'satisfies', type: ChaiType_Enum.METHOD},
  {name: 'satisfy', type: ChaiType_Enum.METHOD},
  {name: 'sealed', type: ChaiType_Enum.PROPERTY},
  {name: 'string', type: ChaiType_Enum.METHOD},
  {name: 'throw', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'Throw', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'throws', type: ChaiType_Enum.METHOD, unsupported: true},
  {name: 'true', type: ChaiType_Enum.PROPERTY},
  {name: 'undefined', type: ChaiType_Enum.PROPERTY},
  {name: 'within', type: ChaiType_Enum.METHOD},
];
...
function installWrappers(chai, utils) {
  const {CHAINABLE_METHOD, METHOD, PROPERTY} = ChaiType_Enum;
