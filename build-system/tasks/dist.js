...
async function dist() {
  ...
  if (argv.esm) {
    await createModuleCompatibleES5Bundle(maybeToEsmName('v0.js'));
    if (!argv.core_runtime_only) {
      await createModuleCompatibleES5Bundle(maybeToEsmName('amp4ads-v0.js'));
      await createModuleCompatibleES5Bundle(maybeToEsmName('shadow-v0.js'));
    }
  }
