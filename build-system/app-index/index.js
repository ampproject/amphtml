  ...
  <wrap>
    <header>
      ...
      <ul>
        ...
        <li><a href="https://github.com/ampproject/amphtml/">Github</a></li>
        <li><a href="https://travis-ci.org/ampproject/amphtml">Travis</a></li>
    ...
    <div class="block proxy-form-contianer">
      <form id="proxy-form">
        ...
        <div class="form-info">
          <a href="https://github.com/ampproject/amphtml/blob/ab14b783907f811d6fc6a076ec7e1697939ab588/contributing/TESTING.md#document-proxy">
            What's this?
          </a>
        </div>
      </form>
...
function renderIndex(req, res) {
  const output = template.replace('<!-- clientScript -->', clientScript);

  fs.readdirAsync('./examples/')
      .then(files => output.replace('<!-- examples -->',
