...
const experimentsConfig = importJSON(
  import.meta.url,
  '../global-configs/experiments-config.json'
);
const experimentsConstantBackup = importJSON(
  import.meta.url,
 ...
 */
export function getExperimentConstant() {
 ...
 * @return {Array<string|Object>}
 */
export function getReplaceGlobalsPlugin() {
  return [
    (babel) => {
      const {types: t} = babel;
      return {
