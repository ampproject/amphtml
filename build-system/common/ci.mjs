 ...
 * @return {boolean}
 */
export function isCircleciBuild() {
  return !!env('CIRCLECI');
}
 ...
 */
export const isGithubActions = isGithubActionsBuild();
export const isCircleci = isCircleciBuild();
 ...
 * @return {boolean}
 */
export function isCircleciPushBranch(branchName) {
 ...
 * @return {boolean}
 */
export function isPullRequestBuild() {
 ...
 * @return {string}
 */
export function ciPullRequestBranch() {
  return isGithubActions
    ? env('GITHUB_HEAD_REF')
    : isCircleci
    ? env('CIRCLE_BRANCH')
 ...
 * @return {string}
 */
export function ciPullRequestSha() {
  return isGithubActions
 ...
 * @return {string}
 */
export function circleciPrMergeCommit() {
 ...
 * @return {string}
 */
export function circleciBuildNumber() {
