...
import {getStdout} from './process.mjs';
 ...
 * @return {string}
 */
export function gitBranchCreationPoint() {
 ...
 * @return {string}
 */
export function gitCiMainBaseline() {
 ...
 * @return {!Array<string>}
 */
export function gitDiffNameOnly() {
 ...
 * @return {!Array<string>}
 */
export function gitDiffNameOnlyMain() {
 ...
 * @return {string}
 */
export function gitDiffStatMain() {
  const mainBaseline = gitMainBaseline();
 ...
 * @return {string}
 */
export function gitDiffCommitLog() {
 ...
 * @return {!Array<string>}
 */
export function gitDiffAddedNameOnlyMain() {
 ...
 * @return {string}
 */
export function gitDiffFileMain(file) {
  const mainBaseline = gitMainBaseline();
 ...
 * @return {string}
 */
export function gitCommitterEmail() {
 ...
 * @return {string}
 */
export function gitCommitFormattedTime(ref = 'HEAD') {
 ...
 * @return {string}
 */
export function gitMergeBaseLocalMain() {
 ...
 * @return {string}
 */
export function gitMainBaseline() {
  if (isCiBuild()) {
 ...
 * @return {string}
 */
export function gitDiffPath(path, commit) {
