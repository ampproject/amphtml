 ...
 * @return {!Object}
 */
export function spawnProcess(cmd, options) {
 ...
 * @return {!Object}
 */
export function getOutput(cmd, options = {}) {
 ...
 * @return {string}
 */
export function getStdout(cmd, options) {
 ...
 * @return {string}
 */
export function getStderr(cmd, options) {
