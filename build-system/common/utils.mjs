import experimentsConfig from '../global-configs/experiments-config.json';
import fs from 'fs-extra';
import globby from 'globby';
import {clean} from '../tasks/clean.mjs';
import {cyan, green, red, yellow} from 'kleur/colors';
import ignore from 'ignore';
import {execOrDie} from './exec.mjs';
import {gitDiffNameOnlyMain} from './git.mjs';
import {log, logLocalDev} from './logging.mjs';
