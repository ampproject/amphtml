...
const {blue, bold, cyan, red} = require('./colors.mjs');
const {getStdout} = require('./process.mjs');
const {log, logWithoutTimestamp} = require('./logging.mjs');
 ...
 */
export function diffTentative(filepath, content, gitDiffFlags = ['-U1']) {
 ...
 * @return {Promise<void>}
 */
export async function writeDiffOrFail(
  callerTask,
  filepath,
  tentative,
  opt_gitDiffFlags
