...
import {mainBinary as mainBinaryWrapper} from './compile-wrappers.mjs';
 ...
 */
export const extensionBundles = importJSON(import.meta.url, './bundles.config.extensions.json');

/**
 * Used to alias a version of an extension to an older deprecated version.
 */
export const extensionAliasBundles = {
  'amp-sticky-ad': {
    version: '1.0',
    aliasedVersion: '0.1',
  },
...
export const verifyExtensionBundles = function () {
