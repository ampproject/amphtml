...
# Where are client-side-experiments-config.json and versioning.json?

These files were moved to the [`ampproject/cdn-configuration`](https://github.com/ampproject/cdn-configuration) repository.
