...
| `gulp dist --version_override=<version_override>`         | Builds production binaries and overrides the version written to the AMP_CONFIG.                                                                                                                                                               |
...
| `gulp build --version_override=<version_override>`        | Builds the AMP library with the specified version.                                                                                                                                                                                            |
...
| `gulp watch --version_override=<version_override>`        | Watches for changes in files, rebuilds. Overrides the version written to the AMP_CONFIG.                                                                                                                                                      |
