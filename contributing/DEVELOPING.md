...
In particular, we try to maintain "it might not be perfect but isn't broken"-support for IE 11, iOS versions older than the latest 2, the Android 4.0 system browser and Chrome 41. 
