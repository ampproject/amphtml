...
In order to support multi-size ad requests, AMP accepts an optional `data` param to `window.context.renderStar
t` (details in 'Methods available to the ad' section) which will automatically invoke request resize with the width and height passed.
