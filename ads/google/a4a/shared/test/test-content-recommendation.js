...
describe('getAutoConfig', function() {
  it('should use image_stacked on wide slots', function() {
    const runTest = (availableWidth, expectedWidth, expectedHeight) => {
      expect(getAutoConfig(availableWidth, /* isMobile= */ false))
          .to.deep.equal({
    ...
    runTest(
        /* availableWidth= */ 1440, /* expectedWidth= */ 1200,
        /* expectedHeight= */ 600);
    runTest(
        /* availableWidth= */ 1200, /* expectedWidth= */ 1200,
        /* expectedHeight= */ 600);
    runTest(
        /* availableWidth= */ 800, /* expectedWidth= */ 800,
        /* expectedHeight= */ 480);
    runTest(
        /* availableWidth= */ 500, /* expectedWidth= */ 500,
        /* expectedHeight= */ 350);
    runTest(
        /* availableWidth= */ 468, /* expectedWidth= */ 468,
        /* expectedHeight= */ 327);
  });

  it('should use mobile_banner_image_sidebyside on narrow slots on mobile',
      function() {
        const runTest = (availableWidth, expectedWidth, expectedHeight) => {
          expect(getAutoConfig(availableWidth, /* isMobile= */ true))
              .to.deep.equal({
        ...
        runTest(
        /* availableWidth= */ 467, /* expectedWidth= */ 467,
            /* expectedHeight= */ 1700);
        runTest(
        /* availableWidth= */ 414, /* expectedWidth= */ 414,
            /* expectedHeight= */ 1520);
        runTest(
        /* availableWidth= */ 360, /* expectedWidth= */ 360,
            /* expectedHeight= */ 1336);
        runTest(
        /* availableWidth= */ 320, /* expectedWidth= */ 320,
            /* expectedHeight= */ 1200);
        runTest(
        /* availableWidth= */ 300, /* expectedWidth= */ 300,
            /* expectedHeight= */ 1131);
        runTest(
        /* availableWidth= */ 200, /* expectedWidth= */ 200,
            /* expectedHeight= */ 791);
        runTest(
        /* availableWidth= */ 120, /* expectedWidth= */ 120,
            /* expectedHeight= */ 519);
      });
  ...
  it('should use image_sidebyside on narrow slots on desktop', function() {
    ...
    runTest(
        ...
        /* expectedHeight= */ 1032);
    runTest(
        /* availableWidth= */ 250, /* expectedWidth= */ 250,
        /* expectedHeight= */ 860);
    runTest(
        /* availableWidth= */ 200, /* expectedWidth= */ 200,
        /* expectedHeight= */ 688);
...
describe('getPubControlConfig', function() {
  it('should use setting when only one provided', function() {
    ...
    const runTest = (availableWidth, expectedWidth, expectedHeight) => {
      expect(getPubControlConfig(availableWidth, rawPubControlParams))
          .to.deep.equal({
    ...
    runTest(
        /* availableWidth= */ 1300, /* expectedWidth= */ 1300,
        /* expectedHeight= */ 513);
    runTest(
        /* availableWidth= */ 1200, /* expectedWidth= */ 1200,
        /* expectedHeight= */ 487);
    ...
    runTest(
        ...
        /* expectedHeight= */ 304);
    runTest(
        /* availableWidth= */ 400, /* expectedWidth= */ 400,
        /* expectedHeight= */ 278);
  });
  ...
  it('should use different settings for mobile and desktop when two provided',
      function() {
        ...
        const runTest =
        (availableWidth, expectedWidth, expectedHeight, expectedConfig) => {
        ...
        runTest(
        /* availableWidth= */ 1300, /* expectedWidth= */ 1300,
            /* expectedHeight= */ 513, expectedDesktopConfig);
        runTest(
        /* availableWidth= */ 1200, /* expectedWidth= */ 1200,
            /* expectedHeight= */ 487, expectedDesktopConfig);
        runTest(
        /* availableWidth= */ 800, /* expectedWidth= */ 800,
            /* expectedHeight= */ 382, expectedDesktopConfig);
        runTest(
        /* availableWidth= */ 500, /* expectedWidth= */ 500,
            /* expectedHeight= */ 304, expectedDesktopConfig);

        // Below 468px the logic should use mobile setting.
        runTest(
        /* availableWidth= */ 400, /* expectedWidth= */ 400,
            /* expectedHeight= */ 333, expectedMobileConfig);
        runTest(
        /* availableWidth= */ 300, /* expectedWidth= */ 300,
            /* expectedHeight= */ 255, expectedMobileConfig);
      });
