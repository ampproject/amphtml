 ...
 * Gulp tasks
 */
gulp.task('build', 'Builds the AMP library', ['yarn-check'], build, {
  options: {
...
gulp.task('css', 'Recompile css to build directory', ['yarn-check'],
    compileCss);
gulp.task('default', 'Same as "watch"', ['yarn-check', 'watch', 'serve']);
gulp.task('dist', 'Build production binaries', ['yarn-check'], dist, {
  options: {
