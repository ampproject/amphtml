...
java -jar $1 \
    ...
    --output_wrapper "/* Generated from closure library commit $GIT_COMMIT */%output%;export function decodeStringToByteArray(input) { return decodeStringToByteArrayEx(input) }; export function hexToByteArray(input) { return hexToByteArrayEx(input) }; export function stringToByteArray(input) { return stringToByteArrayEx(input) };" \
